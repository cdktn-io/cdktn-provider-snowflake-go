...
type DataSnowflakeIcebergTablesConfig struct {
	// Experimental.
	...
	In *DataSnowflakeIcebergTablesIn `field:"optional" json:"in" yaml:"in"`
	...
	Limit *DataSnowflakeIcebergTablesLimit `field:"optional" json:"limit" yaml:"limit"`
