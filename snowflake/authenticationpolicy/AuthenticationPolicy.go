...
func (a *jsiiProxy_AuthenticationPolicy) MarkWriteOnlyAttribute(value interface{}) interface{} {
...
func (a *jsiiProxy_AuthenticationPolicy) RegisterProviderFeatureUsage(feature cdktn.ProviderFeature) {
...
func (a *jsiiProxy_AuthenticationPolicy) With(mixins ...constructs.IMixin) constructs.IConstruct {
	args := []interface{}{}
