...
func (f *jsiiProxy_FileFormat) MarkWriteOnlyAttribute(value interface{}) interface{} {
...
func (f *jsiiProxy_FileFormat) RegisterProviderFeatureUsage(feature cdktn.ProviderFeature) {
...
func (f *jsiiProxy_FileFormat) With(mixins ...constructs.IMixin) constructs.IConstruct {
	args := []interface{}{}
