...
func (j *jsiiProxy_DataSnowflakeUserProgrammaticAccessTokensUserProgrammaticAccessTokensShowOutputList) TerraformResource() cdktn.IInterpolatingParent {
...
func NewDataSnowflakeUserProgrammaticAccessTokensUserProgrammaticAccessTokensShowOutputList(terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) DataSnowflakeUserProgrammaticAccessTokensUserProgrammaticAccessTokensShowOutputList {
	_init_.Initialize()
...
func NewDataSnowflakeUserProgrammaticAccessTokensUserProgrammaticAccessTokensShowOutputList_Override(d DataSnowflakeUserProgrammaticAccessTokensUserProgrammaticAccessTokensShowOutputList, terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) {
	_init_.Initialize()
...
func (j *jsiiProxy_DataSnowflakeUserProgrammaticAccessTokensUserProgrammaticAccessTokensShowOutputList)SetTerraformResource(val cdktn.IInterpolatingParent) {
...
func (d *jsiiProxy_DataSnowflakeUserProgrammaticAccessTokensUserProgrammaticAccessTokensShowOutputList) AllWithMapKey(mapKeyAttributeName *string) cdktn.DynamicListTerraformIterator {
...
func (d *jsiiProxy_DataSnowflakeUserProgrammaticAccessTokensUserProgrammaticAccessTokensShowOutputList) Resolve(context cdktn.IResolveContext) interface{} {
