...
type SnowflakeProviderConfig struct {
	...
	CertRevocationCheckMode *string `field:"optional" json:"certRevocationCheckMode" yaml:"certRevocationCheckMode"`
	...
	CrlAllowCertificatesWithoutCrlUrl *string `field:"optional" json:"crlAllowCertificatesWithoutCrlUrl" yaml:"crlAllowCertificatesWithoutCrlUrl"`
	...
	CrlHttpClientTimeout *float64 `field:"optional" json:"crlHttpClientTimeout" yaml:"crlHttpClientTimeout"`
	// False by default.
	//
	...
	CrlInMemoryCacheDisabled interface{} `field:"optional" json:"crlInMemoryCacheDisabled" yaml:"crlInMemoryCacheDisabled"`
	// False by default.
	//
	...
	CrlOnDiskCacheDisabled interface{} `field:"optional" json:"crlOnDiskCacheDisabled" yaml:"crlOnDiskCacheDisabled"`
	...
	DisableOcspChecks interface{} `field:"optional" json:"disableOcspChecks" yaml:"disableOcspChecks"`
	...
	DisableSamlUrlCheck *string `field:"optional" json:"disableSamlUrlCheck" yaml:"disableSamlUrlCheck"`
	// This field is deprecated.
	//
	...
	LogQueryParameters interface{} `field:"optional" json:"logQueryParameters" yaml:"logQueryParameters"`
	...
	LogQueryText interface{} `field:"optional" json:"logQueryText" yaml:"logQueryText"`
	...
	ProxyPassword *string `field:"optional" json:"proxyPassword" yaml:"proxyPassword"`
	...
	ProxyUser *string `field:"optional" json:"proxyUser" yaml:"proxyUser"`
	...
	TfcWorkloadIdentityTokenTag *string `field:"optional" json:"tfcWorkloadIdentityTokenTag" yaml:"tfcWorkloadIdentityTokenTag"`
