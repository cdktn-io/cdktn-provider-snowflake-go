...
func init() {
	_jsii_.RegisterClass(
		...
		reflect.TypeOf((*FileFormatParquet)(nil)).Elem(),
		[]_jsii_.Member{
	...
	_jsii_.RegisterStruct(
		"@cdktn/provider-snowflake.fileFormatParquet.FileFormatParquetConfig",
		reflect.TypeOf((*FileFormatParquetConfig)(nil)).Elem(),
	)
	_jsii_.RegisterStruct(
		"@cdktn/provider-snowflake.fileFormatParquet.FileFormatParquetDescribeOutput",
		reflect.TypeOf((*FileFormatParquetDescribeOutput)(nil)).Elem(),
	)
	_jsii_.RegisterClass(
		"@cdktn/provider-snowflake.fileFormatParquet.FileFormatParquetDescribeOutputList",
		reflect.TypeOf((*FileFormatParquetDescribeOutputList)(nil)).Elem(),
		[]_jsii_.Member{
	...
	_jsii_.RegisterClass(
		...
		reflect.TypeOf((*FileFormatParquetDescribeOutputOutputReference)(nil)).Elem(),
		[]_jsii_.Member{
			_jsii_.MemberProperty{JsiiProperty: "binaryAsText", GoGetter: "BinaryAsText"},
	...
	_jsii_.RegisterStruct(
		"@cdktn/provider-snowflake.fileFormatParquet.FileFormatParquetShowOutput",
		reflect.TypeOf((*FileFormatParquetShowOutput)(nil)).Elem(),
	)
	_jsii_.RegisterClass(
		"@cdktn/provider-snowflake.fileFormatParquet.FileFormatParquetShowOutputList",
		reflect.TypeOf((*FileFormatParquetShowOutputList)(nil)).Elem(),
		[]_jsii_.Member{
			_jsii_.MemberMethod{JsiiMethod: "allWithMapKey", GoMethod: "AllWithMapKey"},
			_jsii_.MemberMethod{JsiiMethod: "computeFqn", GoMethod: "ComputeFqn"},
			_jsii_.MemberProperty{JsiiProperty: "creationStack", GoGetter: "CreationStack"},
	...
	_jsii_.RegisterClass(
		"@cdktn/provider-snowflake.fileFormatParquet.FileFormatParquetShowOutputOutputReference",
		reflect.TypeOf((*FileFormatParquetShowOutputOutputReference)(nil)).Elem(),
		[]_jsii_.Member{
			_jsii_.MemberProperty{JsiiProperty: "comment", GoGetter: "Comment"},
			_jsii_.MemberProperty{JsiiProperty: "complexObjectIndex", GoGetter: "ComplexObjectIndex"},
			_jsii_.MemberProperty{JsiiProperty: "complexObjectIsFromSet", GoGetter: "ComplexObjectIsFromSet"},
		...
		func() interface{} {
			j := jsiiProxy_FileFormatParquetShowOutputOutputReference{}
			_jsii_.InitJsiiProxy(&j.Type__cdktnComplexObject)
			return &j
		},
	)
	_jsii_.RegisterStruct(
		"@cdktn/provider-snowflake.fileFormatParquet.FileFormatParquetTimeouts",
		reflect.TypeOf((*FileFormatParquetTimeouts)(nil)).Elem(),
	)
	_jsii_.RegisterClass(
		"@cdktn/provider-snowflake.fileFormatParquet.FileFormatParquetTimeoutsOutputReference",
		reflect.TypeOf((*FileFormatParquetTimeoutsOutputReference)(nil)).Elem(),
		[]_jsii_.Member{
			_jsii_.MemberProperty{JsiiProperty: "complexObjectIndex", GoGetter: "ComplexObjectIndex"},
			_jsii_.MemberProperty{JsiiProperty: "complexObjectIsFromSet", GoGetter: "ComplexObjectIsFromSet"},
			_jsii_.MemberMethod{JsiiMethod: "computeFqn", GoMethod: "ComputeFqn"},
