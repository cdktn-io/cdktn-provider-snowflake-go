...
func (j *jsiiProxy_FunctionScala) LogEventLevel() *string {
	var returns *string
	_jsii_.Get(
		j,
		"logEventLevel",
...
func (j *jsiiProxy_FunctionScala) LogEventLevelInput() *string {
	var returns *string
	_jsii_.Get(
		j,
		"logEventLevelInput",
...
func (j *jsiiProxy_FunctionScala)SetLogEventLevel(val *string) {
...
func (f *jsiiProxy_FunctionScala) MarkWriteOnlyAttribute(value interface{}) interface{} {
...
func (f *jsiiProxy_FunctionScala) RegisterProviderFeatureUsage(feature cdktn.ProviderFeature) {
...
func (f *jsiiProxy_FunctionScala) ResetLogEventLevel() {
	_jsii_.InvokeVoid(
		f,
		"resetLogEventLevel",
		nil, // no parameters
...
func (f *jsiiProxy_FunctionScala) With(mixins ...constructs.IMixin) constructs.IConstruct {
	args := []interface{}{}
