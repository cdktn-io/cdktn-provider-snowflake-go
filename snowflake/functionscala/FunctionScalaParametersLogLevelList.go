...
func (j *jsiiProxy_FunctionScalaParametersLogLevelList) TerraformResource() cdktn.IInterpolatingParent {
...
func NewFunctionScalaParametersLogLevelList(terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) FunctionScalaParametersLogLevelList {
	_init_.Initialize()
...
func NewFunctionScalaParametersLogLevelList_Override(f FunctionScalaParametersLogLevelList, terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) {
	_init_.Initialize()
...
func (j *jsiiProxy_FunctionScalaParametersLogLevelList)SetTerraformResource(val cdktn.IInterpolatingParent) {
...
func (f *jsiiProxy_FunctionScalaParametersLogLevelList) AllWithMapKey(mapKeyAttributeName *string) cdktn.DynamicListTerraformIterator {
...
func (f *jsiiProxy_FunctionScalaParametersLogLevelList) Resolve(context cdktn.IResolveContext) interface{} {
