...
import (
	...
	"github.com/cdktn-io/cdktn-provider-snowflake-go/snowflake/v18/datasnowflakeparameters/internal"
...
func (j *jsiiProxy_DataSnowflakeParameters) CdktfStack() cdktn.TerraformStack {
...
func (j *jsiiProxy_DataSnowflakeParameters) ForEach() cdktn.ITerraformIterator {
...
func (j *jsiiProxy_DataSnowflakeParameters) Lifecycle() *cdktn.TerraformResourceLifecycle {
...
func (j *jsiiProxy_DataSnowflakeParameters) Provider() cdktn.TerraformProvider {
...
func (j *jsiiProxy_DataSnowflakeParameters) TerraformGeneratorMetadata() *cdktn.TerraformProviderGeneratorMetadata {
...
func (j *jsiiProxy_DataSnowflakeParameters)SetForEach(val cdktn.ITerraformIterator) {
	_jsii_.Set(
		j,
		"forEach",
		val,
...
func (j *jsiiProxy_DataSnowflakeParameters)SetLifecycle(val *cdktn.TerraformResourceLifecycle) {
...
func (j *jsiiProxy_DataSnowflakeParameters)SetProvider(val cdktn.TerraformProvider) {
	_jsii_.Set(
		j,
		"provider",
		val,
...
func DataSnowflakeParameters_GenerateConfigForImport(scope constructs.Construct, importToId *string, importFromId *string, provider cdktn.TerraformProvider) cdktn.ImportableResource {
	_init_.Initialize()
...
func (d *jsiiProxy_DataSnowflakeParameters) GetBooleanAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (d *jsiiProxy_DataSnowflakeParameters) InterpolationForAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (d *jsiiProxy_DataSnowflakeParameters) RegisterProviderFeatureUsage(feature cdktn.ProviderFeature) {
...
func (d *jsiiProxy_DataSnowflakeParameters) With(mixins ...constructs.IMixin) constructs.IConstruct {
	args := []interface{}{}
