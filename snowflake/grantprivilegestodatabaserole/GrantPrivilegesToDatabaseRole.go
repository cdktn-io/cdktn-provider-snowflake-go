...
func (g *jsiiProxy_GrantPrivilegesToDatabaseRole) MarkWriteOnlyAttribute(value interface{}) interface{} {
...
func (g *jsiiProxy_GrantPrivilegesToDatabaseRole) RegisterProviderFeatureUsage(feature cdktn.ProviderFeature) {
...
func (g *jsiiProxy_GrantPrivilegesToDatabaseRole) With(mixins ...constructs.IMixin) constructs.IConstruct {
	args := []interface{}{}
