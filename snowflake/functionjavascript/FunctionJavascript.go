...
func (j *jsiiProxy_FunctionJavascript) LogEventLevel() *string {
	var returns *string
	_jsii_.Get(
		j,
		"logEventLevel",
...
func (j *jsiiProxy_FunctionJavascript) LogEventLevelInput() *string {
	var returns *string
	_jsii_.Get(
		j,
		"logEventLevelInput",
...
func (j *jsiiProxy_FunctionJavascript)SetLogEventLevel(val *string) {
...
func (f *jsiiProxy_FunctionJavascript) MarkWriteOnlyAttribute(value interface{}) interface{} {
...
func (f *jsiiProxy_FunctionJavascript) RegisterProviderFeatureUsage(feature cdktn.ProviderFeature) {
...
func (f *jsiiProxy_FunctionJavascript) ResetLogEventLevel() {
	_jsii_.InvokeVoid(
		f,
		"resetLogEventLevel",
		nil, // no parameters
