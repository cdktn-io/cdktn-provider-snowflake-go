...
func (d *jsiiProxy_DataSnowflakeRowAccessPoliciesRowAccessPoliciesList) validateResolveParameters(context cdktn.IResolveContext) error {
	if context == nil {
...
func (j *jsiiProxy_DataSnowflakeRowAccessPoliciesRowAccessPoliciesList) validateSetTerraformResourceParameters(val cdktn.IInterpolatingParent) error {
	if val == nil {
		return fmt.Errorf("parameter val is required, but nil was provided")
	}
...
func validateNewDataSnowflakeRowAccessPoliciesRowAccessPoliciesListParameters(terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) error {
