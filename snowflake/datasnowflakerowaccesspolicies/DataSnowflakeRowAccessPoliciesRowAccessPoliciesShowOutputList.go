...
func (j *jsiiProxy_DataSnowflakeRowAccessPoliciesRowAccessPoliciesShowOutputList) TerraformResource() cdktn.IInterpolatingParent {
...
func NewDataSnowflakeRowAccessPoliciesRowAccessPoliciesShowOutputList(terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) DataSnowflakeRowAccessPoliciesRowAccessPoliciesShowOutputList {
	_init_.Initialize()
...
func NewDataSnowflakeRowAccessPoliciesRowAccessPoliciesShowOutputList_Override(d DataSnowflakeRowAccessPoliciesRowAccessPoliciesShowOutputList, terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) {
	_init_.Initialize()
...
func (j *jsiiProxy_DataSnowflakeRowAccessPoliciesRowAccessPoliciesShowOutputList)SetTerraformResource(val cdktn.IInterpolatingParent) {
...
func (d *jsiiProxy_DataSnowflakeRowAccessPoliciesRowAccessPoliciesShowOutputList) AllWithMapKey(mapKeyAttributeName *string) cdktn.DynamicListTerraformIterator {
...
func (d *jsiiProxy_DataSnowflakeRowAccessPoliciesRowAccessPoliciesShowOutputList) Resolve(context cdktn.IResolveContext) interface{} {
