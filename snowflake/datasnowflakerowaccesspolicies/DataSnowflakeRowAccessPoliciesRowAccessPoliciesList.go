...
func (j *jsiiProxy_DataSnowflakeRowAccessPoliciesRowAccessPoliciesList) TerraformResource() cdktn.IInterpolatingParent {
...
func NewDataSnowflakeRowAccessPoliciesRowAccessPoliciesList(terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) DataSnowflakeRowAccessPoliciesRowAccessPoliciesList {
	_init_.Initialize()
...
func NewDataSnowflakeRowAccessPoliciesRowAccessPoliciesList_Override(d DataSnowflakeRowAccessPoliciesRowAccessPoliciesList, terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) {
	_init_.Initialize()
...
func (j *jsiiProxy_DataSnowflakeRowAccessPoliciesRowAccessPoliciesList)SetTerraformResource(val cdktn.IInterpolatingParent) {
...
func (d *jsiiProxy_DataSnowflakeRowAccessPoliciesRowAccessPoliciesList) AllWithMapKey(mapKeyAttributeName *string) cdktn.DynamicListTerraformIterator {
...
func (d *jsiiProxy_DataSnowflakeRowAccessPoliciesRowAccessPoliciesList) Resolve(context cdktn.IResolveContext) interface{} {
