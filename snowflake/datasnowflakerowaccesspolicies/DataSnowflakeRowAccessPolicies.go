...
func (d *jsiiProxy_DataSnowflakeRowAccessPolicies) RegisterProviderFeatureUsage(feature cdktn.ProviderFeature) {
...
func (d *jsiiProxy_DataSnowflakeRowAccessPolicies) With(mixins ...constructs.IMixin) constructs.IConstruct {
	args := []interface{}{}
