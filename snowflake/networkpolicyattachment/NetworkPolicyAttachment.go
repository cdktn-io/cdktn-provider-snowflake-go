...
func (n *jsiiProxy_NetworkPolicyAttachment) MarkWriteOnlyAttribute(value interface{}) interface{} {
...
func (n *jsiiProxy_NetworkPolicyAttachment) RegisterProviderFeatureUsage(feature cdktn.ProviderFeature) {
...
func (n *jsiiProxy_NetworkPolicyAttachment) With(mixins ...constructs.IMixin) constructs.IConstruct {
	args := []interface{}{}
