...
func (s *jsiiProxy_SessionPolicy) MarkWriteOnlyAttribute(value interface{}) interface{} {
...
func (s *jsiiProxy_SessionPolicy) RegisterProviderFeatureUsage(feature cdktn.ProviderFeature) {
