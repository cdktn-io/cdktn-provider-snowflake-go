...
func init() {
	_jsii_.RegisterClass(
		...
		reflect.TypeOf((*SessionPolicy)(nil)).Elem(),
		[]_jsii_.Member{
			_jsii_.MemberMethod{JsiiMethod: "addMoveTarget", GoMethod: "AddMoveTarget"},
			_jsii_.MemberMethod{JsiiMethod: "addOverride", GoMethod: "AddOverride"},
			_jsii_.MemberProperty{JsiiProperty: "allowedSecondaryRoles", GoGetter: "AllowedSecondaryRoles"},
			_jsii_.MemberProperty{JsiiProperty: "allowedSecondaryRolesInput", GoGetter: "AllowedSecondaryRolesInput"},
			_jsii_.MemberProperty{JsiiProperty: "blockedSecondaryRoles", GoGetter: "BlockedSecondaryRoles"},
			_jsii_.MemberProperty{JsiiProperty: "blockedSecondaryRolesInput", GoGetter: "BlockedSecondaryRolesInput"},
			...
			_jsii_.MemberMethod{JsiiMethod: "putAllowedSecondaryRoles", GoMethod: "PutAllowedSecondaryRoles"},
			_jsii_.MemberMethod{JsiiMethod: "putBlockedSecondaryRoles", GoMethod: "PutBlockedSecondaryRoles"},
			_jsii_.MemberMethod{JsiiMethod: "putTimeouts", GoMethod: "PutTimeouts"},
			_jsii_.MemberProperty{JsiiProperty: "rawOverrides", GoGetter: "RawOverrides"},
			_jsii_.MemberMethod{JsiiMethod: "registerProviderFeatureUsage", GoMethod: "RegisterProviderFeatureUsage"},
			_jsii_.MemberMethod{JsiiMethod: "resetAllowedSecondaryRoles", GoMethod: "ResetAllowedSecondaryRoles"},
			_jsii_.MemberMethod{JsiiMethod: "resetBlockedSecondaryRoles", GoMethod: "ResetBlockedSecondaryRoles"},
			_jsii_.MemberMethod{JsiiMethod: "resetComment", GoMethod: "ResetComment"},
			_jsii_.MemberMethod{JsiiMethod: "resetId", GoMethod: "ResetId"},
			_jsii_.MemberMethod{JsiiMethod: "resetOverrideLogicalId", GoMethod: "ResetOverrideLogicalId"},
			_jsii_.MemberMethod{JsiiMethod: "resetSessionIdleTimeoutMins", GoMethod: "ResetSessionIdleTimeoutMins"},
			_jsii_.MemberMethod{JsiiMethod: "resetSessionUiIdleTimeoutMins", GoMethod: "ResetSessionUiIdleTimeoutMins"},
			...
			_jsii_.MemberProperty{JsiiProperty: "sessionIdleTimeoutMinsInput", GoGetter: "SessionIdleTimeoutMinsInput"},
			_jsii_.MemberProperty{JsiiProperty: "sessionUiIdleTimeoutMins", GoGetter: "SessionUiIdleTimeoutMins"},
			_jsii_.MemberProperty{JsiiProperty: "sessionUiIdleTimeoutMinsInput", GoGetter: "SessionUiIdleTimeoutMinsInput"},
	...
	_jsii_.RegisterStruct(
		...
		reflect.TypeOf((*SessionPolicyAllowedSecondaryRoles)(nil)).Elem(),
	)
	_jsii_.RegisterClass(
		"@cdktn/provider-snowflake.sessionPolicy.SessionPolicyAllowedSecondaryRolesOutputReference",
		reflect.TypeOf((*SessionPolicyAllowedSecondaryRolesOutputReference)(nil)).Elem(),
		[]_jsii_.Member{
	...
	_jsii_.RegisterStruct(
		...
		reflect.TypeOf((*SessionPolicyBlockedSecondaryRoles)(nil)).Elem(),
	)
	_jsii_.RegisterClass(
		"@cdktn/provider-snowflake.sessionPolicy.SessionPolicyBlockedSecondaryRolesOutputReference",
		reflect.TypeOf((*SessionPolicyBlockedSecondaryRolesOutputReference)(nil)).Elem(),
		[]_jsii_.Member{
			_jsii_.MemberProperty{JsiiProperty: "all", GoGetter: "All"},
			_jsii_.MemberProperty{JsiiProperty: "allInput", GoGetter: "AllInput"},
			_jsii_.MemberProperty{JsiiProperty: "complexObjectIndex", GoGetter: "ComplexObjectIndex"},
	...
	_jsii_.RegisterStruct(
		...
		reflect.TypeOf((*SessionPolicyConfig)(nil)).Elem(),
	)
	_jsii_.RegisterStruct(
		"@cdktn/provider-snowflake.sessionPolicy.SessionPolicyDescribeOutput",
		reflect.TypeOf((*SessionPolicyDescribeOutput)(nil)).Elem(),
	)
	_jsii_.RegisterClass(
		"@cdktn/provider-snowflake.sessionPolicy.SessionPolicyDescribeOutputList",
		reflect.TypeOf((*SessionPolicyDescribeOutputList)(nil)).Elem(),
		[]_jsii_.Member{
		...
		func() interface{} {
			j := jsiiProxy_SessionPolicyDescribeOutputList{}
	...
	_jsii_.RegisterClass(
		...
		reflect.TypeOf((*SessionPolicyDescribeOutputOutputReference)(nil)).Elem(),
		[]_jsii_.Member{
			_jsii_.MemberProperty{JsiiProperty: "allowedSecondaryRoles", GoGetter: "AllowedSecondaryRoles"},
			_jsii_.MemberProperty{JsiiProperty: "blockedSecondaryRoles", GoGetter: "BlockedSecondaryRoles"},
			_jsii_.MemberProperty{JsiiProperty: "comment", GoGetter: "Comment"},
	...
	_jsii_.RegisterStruct(
		...
		reflect.TypeOf((*SessionPolicyShowOutput)(nil)).Elem(),
	)
	_jsii_.RegisterClass(
		"@cdktn/provider-snowflake.sessionPolicy.SessionPolicyShowOutputList",
		reflect.TypeOf((*SessionPolicyShowOutputList)(nil)).Elem(),
		[]_jsii_.Member{
			_jsii_.MemberMethod{JsiiMethod: "allWithMapKey", GoMethod: "AllWithMapKey"},
			_jsii_.MemberMethod{JsiiMethod: "computeFqn", GoMethod: "ComputeFqn"},
			_jsii_.MemberProperty{JsiiProperty: "creationStack", GoGetter: "CreationStack"},
		...
		func() interface{} {
			j := jsiiProxy_SessionPolicyShowOutputList{}
			_jsii_.InitJsiiProxy(&j.Type__cdktnComplexList)
			return &j
		},
	)
	_jsii_.RegisterClass(
		...
		reflect.TypeOf((*SessionPolicyShowOutputOutputReference)(nil)).Elem(),
		[]_jsii_.Member{
			_jsii_.MemberProperty{JsiiProperty: "comment", GoGetter: "Comment"},
			_jsii_.MemberProperty{JsiiProperty: "complexObjectIndex", GoGetter: "ComplexObjectIndex"},
			_jsii_.MemberProperty{JsiiProperty: "complexObjectIsFromSet", GoGetter: "ComplexObjectIsFromSet"},
	...
	_jsii_.RegisterStruct(
		...
		reflect.TypeOf((*SessionPolicyTimeouts)(nil)).Elem(),
	)
	_jsii_.RegisterClass(
		"@cdktn/provider-snowflake.sessionPolicy.SessionPolicyTimeoutsOutputReference",
		reflect.TypeOf((*SessionPolicyTimeoutsOutputReference)(nil)).Elem(),
		[]_jsii_.Member{
			_jsii_.MemberProperty{JsiiProperty: "complexObjectIndex", GoGetter: "ComplexObjectIndex"},
			_jsii_.MemberProperty{JsiiProperty: "complexObjectIsFromSet", GoGetter: "ComplexObjectIsFromSet"},
			_jsii_.MemberMethod{JsiiMethod: "computeFqn", GoMethod: "ComputeFqn"},
