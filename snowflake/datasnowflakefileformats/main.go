...
func init() {
	...
	_jsii_.RegisterStruct(
		"@cdktn/provider-snowflake.dataSnowflakeFileFormats.DataSnowflakeFileFormatsFileFormatsDescribeOutput",
		reflect.TypeOf((*DataSnowflakeFileFormatsFileFormatsDescribeOutput)(nil)).Elem(),
	)
	_jsii_.RegisterClass(
		"@cdktn/provider-snowflake.dataSnowflakeFileFormats.DataSnowflakeFileFormatsFileFormatsDescribeOutputList",
		reflect.TypeOf((*DataSnowflakeFileFormatsFileFormatsDescribeOutputList)(nil)).Elem(),
		[]_jsii_.Member{
	...
	_jsii_.RegisterClass(
		...
		reflect.TypeOf((*DataSnowflakeFileFormatsFileFormatsDescribeOutputOutputReference)(nil)).Elem(),
		[]_jsii_.Member{
	...
	_jsii_.RegisterStruct(
		"@cdktn/provider-snowflake.dataSnowflakeFileFormats.DataSnowflakeFileFormatsFileFormatsShowOutput",
		reflect.TypeOf((*DataSnowflakeFileFormatsFileFormatsShowOutput)(nil)).Elem(),
	)
	_jsii_.RegisterClass(
		"@cdktn/provider-snowflake.dataSnowflakeFileFormats.DataSnowflakeFileFormatsFileFormatsShowOutputList",
		reflect.TypeOf((*DataSnowflakeFileFormatsFileFormatsShowOutputList)(nil)).Elem(),
		[]_jsii_.Member{
			_jsii_.MemberMethod{JsiiMethod: "allWithMapKey", GoMethod: "AllWithMapKey"},
			_jsii_.MemberMethod{JsiiMethod: "computeFqn", GoMethod: "ComputeFqn"},
			_jsii_.MemberProperty{JsiiProperty: "creationStack", GoGetter: "CreationStack"},
	...
	_jsii_.RegisterClass(
		...
		reflect.TypeOf((*DataSnowflakeFileFormatsFileFormatsShowOutputOutputReference)(nil)).Elem(),
		[]_jsii_.Member{
	...
	_jsii_.RegisterStruct(
		"@cdktn/provider-snowflake.dataSnowflakeFileFormats.DataSnowflakeFileFormatsIn",
		reflect.TypeOf((*DataSnowflakeFileFormatsIn)(nil)).Elem(),
	)
	_jsii_.RegisterClass(
		"@cdktn/provider-snowflake.dataSnowflakeFileFormats.DataSnowflakeFileFormatsInOutputReference",
		reflect.TypeOf((*DataSnowflakeFileFormatsInOutputReference)(nil)).Elem(),
		[]_jsii_.Member{
