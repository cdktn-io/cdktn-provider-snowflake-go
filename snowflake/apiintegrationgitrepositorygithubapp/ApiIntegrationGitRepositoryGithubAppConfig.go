...
type ApiIntegrationGitRepositoryGithubAppConfig struct {
	// Experimental.
	...
	Timeouts *ApiIntegrationGitRepositoryGithubAppTimeouts `field:"optional" json:"timeouts" yaml:"timeouts"`
}
