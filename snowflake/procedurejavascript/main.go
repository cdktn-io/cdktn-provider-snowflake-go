...
func init() {
	...
	_jsii_.RegisterStruct(
		"@cdktn/provider-snowflake.procedureJavascript.ProcedureJavascriptParametersLogEventLevel",
		reflect.TypeOf((*ProcedureJavascriptParametersLogEventLevel)(nil)).Elem(),
	)
	_jsii_.RegisterClass(
		"@cdktn/provider-snowflake.procedureJavascript.ProcedureJavascriptParametersLogEventLevelList",
		reflect.TypeOf((*ProcedureJavascriptParametersLogEventLevelList)(nil)).Elem(),
		[]_jsii_.Member{
			_jsii_.MemberMethod{JsiiMethod: "allWithMapKey", GoMethod: "AllWithMapKey"},
			_jsii_.MemberMethod{JsiiMethod: "computeFqn", GoMethod: "ComputeFqn"},
			_jsii_.MemberProperty{JsiiProperty: "creationStack", GoGetter: "CreationStack"},
	...
	_jsii_.RegisterClass(
		...
		reflect.TypeOf((*ProcedureJavascriptParametersLogEventLevelOutputReference)(nil)).Elem(),
		[]_jsii_.Member{
			_jsii_.MemberProperty{JsiiProperty: "complexObjectIndex", GoGetter: "ComplexObjectIndex"},
			_jsii_.MemberProperty{JsiiProperty: "complexObjectIsFromSet", GoGetter: "ComplexObjectIsFromSet"},
			_jsii_.MemberMethod{JsiiMethod: "computeFqn", GoMethod: "ComputeFqn"},
