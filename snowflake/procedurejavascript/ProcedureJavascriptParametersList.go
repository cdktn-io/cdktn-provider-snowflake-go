...
func (j *jsiiProxy_ProcedureJavascriptParametersList) TerraformResource() cdktn.IInterpolatingParent {
...
func NewProcedureJavascriptParametersList(terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) ProcedureJavascriptParametersList {
	_init_.Initialize()
...
func NewProcedureJavascriptParametersList_Override(p ProcedureJavascriptParametersList, terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) {
	_init_.Initialize()
...
func (j *jsiiProxy_ProcedureJavascriptParametersList)SetTerraformResource(val cdktn.IInterpolatingParent) {
...
func (p *jsiiProxy_ProcedureJavascriptParametersList) AllWithMapKey(mapKeyAttributeName *string) cdktn.DynamicListTerraformIterator {
...
func (p *jsiiProxy_ProcedureJavascriptParametersList) Resolve(context cdktn.IResolveContext) interface{} {
