...
func (j *jsiiProxy_HybridTableColumnList) validateSetInternalValueParameters(val interface{}) error {
	...
	case cdktn.IResolvable:
		// ok
	case *[]*HybridTableColumn:
		val := val.(*[]*HybridTableColumn)
	...
	default:
		if !_jsii_.IsAnonymousProxy(val) {
			return fmt.Errorf("parameter val must be one of the allowed types: cdktn.IResolvable, *[]*HybridTableColumn; received %#v (a %T)", val, val)
		}
	}
