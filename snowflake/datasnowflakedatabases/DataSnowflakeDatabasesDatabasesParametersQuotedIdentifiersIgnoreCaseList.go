...
func (j *jsiiProxy_DataSnowflakeDatabasesDatabasesParametersQuotedIdentifiersIgnoreCaseList) TerraformResource() cdktn.IInterpolatingParent {
...
func NewDataSnowflakeDatabasesDatabasesParametersQuotedIdentifiersIgnoreCaseList(terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) DataSnowflakeDatabasesDatabasesParametersQuotedIdentifiersIgnoreCaseList {
	_init_.Initialize()
...
func NewDataSnowflakeDatabasesDatabasesParametersQuotedIdentifiersIgnoreCaseList_Override(d DataSnowflakeDatabasesDatabasesParametersQuotedIdentifiersIgnoreCaseList, terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) {
	_init_.Initialize()
...
func (j *jsiiProxy_DataSnowflakeDatabasesDatabasesParametersQuotedIdentifiersIgnoreCaseList)SetTerraformResource(val cdktn.IInterpolatingParent) {
...
func (d *jsiiProxy_DataSnowflakeDatabasesDatabasesParametersQuotedIdentifiersIgnoreCaseList) AllWithMapKey(mapKeyAttributeName *string) cdktn.DynamicListTerraformIterator {
...
func (d *jsiiProxy_DataSnowflakeDatabasesDatabasesParametersQuotedIdentifiersIgnoreCaseList) Resolve(context cdktn.IResolveContext) interface{} {
