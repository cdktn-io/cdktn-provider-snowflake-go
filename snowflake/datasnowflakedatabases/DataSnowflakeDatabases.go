...
func (d *jsiiProxy_DataSnowflakeDatabases) RegisterProviderFeatureUsage(feature cdktn.ProviderFeature) {
...
func (d *jsiiProxy_DataSnowflakeDatabases) With(mixins ...constructs.IMixin) constructs.IConstruct {
	args := []interface{}{}
