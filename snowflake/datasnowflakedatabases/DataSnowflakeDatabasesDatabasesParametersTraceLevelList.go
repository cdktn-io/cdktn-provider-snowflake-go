...
func (j *jsiiProxy_DataSnowflakeDatabasesDatabasesParametersTraceLevelList) TerraformResource() cdktn.IInterpolatingParent {
...
func NewDataSnowflakeDatabasesDatabasesParametersTraceLevelList(terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) DataSnowflakeDatabasesDatabasesParametersTraceLevelList {
	_init_.Initialize()
...
func NewDataSnowflakeDatabasesDatabasesParametersTraceLevelList_Override(d DataSnowflakeDatabasesDatabasesParametersTraceLevelList, terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) {
	_init_.Initialize()
...
func (j *jsiiProxy_DataSnowflakeDatabasesDatabasesParametersTraceLevelList)SetTerraformResource(val cdktn.IInterpolatingParent) {
...
func (d *jsiiProxy_DataSnowflakeDatabasesDatabasesParametersTraceLevelList) AllWithMapKey(mapKeyAttributeName *string) cdktn.DynamicListTerraformIterator {
...
func (d *jsiiProxy_DataSnowflakeDatabasesDatabasesParametersTraceLevelList) Resolve(context cdktn.IResolveContext) interface{} {
