...
func (m *jsiiProxy_MaterializedView) MarkWriteOnlyAttribute(value interface{}) interface{} {
...
func (m *jsiiProxy_MaterializedView) RegisterProviderFeatureUsage(feature cdktn.ProviderFeature) {
...
func (m *jsiiProxy_MaterializedView) With(mixins ...constructs.IMixin) constructs.IConstruct {
	args := []interface{}{}
