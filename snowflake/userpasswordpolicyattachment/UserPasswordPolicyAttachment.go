...
import (
	...
	"github.com/cdktn-io/cdktn-provider-snowflake-go/snowflake/v18/userpasswordpolicyattachment/internal"
...
func (u *jsiiProxy_UserPasswordPolicyAttachment) MarkWriteOnlyAttribute(value interface{}) interface{} {
...
func (u *jsiiProxy_UserPasswordPolicyAttachment) RegisterProviderFeatureUsage(feature cdktn.ProviderFeature) {
