...
func (j *jsiiProxy_ProcedureScalaParametersMetricLevelList) TerraformResource() cdktn.IInterpolatingParent {
...
func NewProcedureScalaParametersMetricLevelList(terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) ProcedureScalaParametersMetricLevelList {
	_init_.Initialize()
...
func NewProcedureScalaParametersMetricLevelList_Override(p ProcedureScalaParametersMetricLevelList, terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) {
	_init_.Initialize()
...
func (j *jsiiProxy_ProcedureScalaParametersMetricLevelList)SetTerraformResource(val cdktn.IInterpolatingParent) {
...
func (p *jsiiProxy_ProcedureScalaParametersMetricLevelList) AllWithMapKey(mapKeyAttributeName *string) cdktn.DynamicListTerraformIterator {
...
func (p *jsiiProxy_ProcedureScalaParametersMetricLevelList) Resolve(context cdktn.IResolveContext) interface{} {
