...
func (j *jsiiProxy_DataSnowflakeAlertsAlertsList) TerraformResource() cdktn.IInterpolatingParent {
...
func NewDataSnowflakeAlertsAlertsList(terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) DataSnowflakeAlertsAlertsList {
	_init_.Initialize()
...
func NewDataSnowflakeAlertsAlertsList_Override(d DataSnowflakeAlertsAlertsList, terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) {
	_init_.Initialize()
...
func (j *jsiiProxy_DataSnowflakeAlertsAlertsList)SetTerraformResource(val cdktn.IInterpolatingParent) {
...
func (d *jsiiProxy_DataSnowflakeAlertsAlertsList) AllWithMapKey(mapKeyAttributeName *string) cdktn.DynamicListTerraformIterator {
...
func (d *jsiiProxy_DataSnowflakeAlertsAlertsList) Resolve(context cdktn.IResolveContext) interface{} {
