...
func (d *jsiiProxy_DataSnowflakeTasksTasksParametersUserTaskManagedInitialWarehouseSizeList) validateResolveParameters(context cdktn.IResolveContext) error {
	if context == nil {
...
func (j *jsiiProxy_DataSnowflakeTasksTasksParametersUserTaskManagedInitialWarehouseSizeList) validateSetTerraformResourceParameters(val cdktn.IInterpolatingParent) error {
	if val == nil {
		return fmt.Errorf("parameter val is required, but nil was provided")
	}
...
func validateNewDataSnowflakeTasksTasksParametersUserTaskManagedInitialWarehouseSizeListParameters(terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) error {
