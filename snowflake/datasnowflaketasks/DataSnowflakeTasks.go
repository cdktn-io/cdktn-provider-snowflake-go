...
func (d *jsiiProxy_DataSnowflakeTasks) RegisterProviderFeatureUsage(feature cdktn.ProviderFeature) {
...
func (d *jsiiProxy_DataSnowflakeTasks) With(mixins ...constructs.IMixin) constructs.IConstruct {
	args := []interface{}{}
