...
func (u *jsiiProxy_UserParametersStatementQueuedTimeoutInSecondsList) validateResolveParameters(context cdktn.IResolveContext) error {
	if context == nil {
...
func (j *jsiiProxy_UserParametersStatementQueuedTimeoutInSecondsList) validateSetTerraformResourceParameters(val cdktn.IInterpolatingParent) error {
	if val == nil {
		return fmt.Errorf("parameter val is required, but nil was provided")
	}
...
func validateNewUserParametersStatementQueuedTimeoutInSecondsListParameters(terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) error {
