...
func (j *jsiiProxy_UserParametersSearchPathList) TerraformResource() cdktn.IInterpolatingParent {
...
func NewUserParametersSearchPathList(terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) UserParametersSearchPathList {
	_init_.Initialize()
...
func NewUserParametersSearchPathList_Override(u UserParametersSearchPathList, terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) {
	_init_.Initialize()
...
func (j *jsiiProxy_UserParametersSearchPathList)SetTerraformResource(val cdktn.IInterpolatingParent) {
...
func (u *jsiiProxy_UserParametersSearchPathList) AllWithMapKey(mapKeyAttributeName *string) cdktn.DynamicListTerraformIterator {
...
func (u *jsiiProxy_UserParametersSearchPathList) Resolve(context cdktn.IResolveContext) interface{} {
