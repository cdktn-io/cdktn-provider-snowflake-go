...
func (u *jsiiProxy_UserParametersJdbcUseSessionTimezoneList) validateResolveParameters(context cdktn.IResolveContext) error {
	return nil
}
...
func (j *jsiiProxy_UserParametersJdbcUseSessionTimezoneList) validateSetTerraformResourceParameters(val cdktn.IInterpolatingParent) error {
	return nil
}
...
func validateNewUserParametersJdbcUseSessionTimezoneListParameters(terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) error {
	return nil
}
