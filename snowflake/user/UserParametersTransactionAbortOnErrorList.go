...
func (j *jsiiProxy_UserParametersTransactionAbortOnErrorList) TerraformResource() cdktn.IInterpolatingParent {
...
func NewUserParametersTransactionAbortOnErrorList(terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) UserParametersTransactionAbortOnErrorList {
	_init_.Initialize()
...
func NewUserParametersTransactionAbortOnErrorList_Override(u UserParametersTransactionAbortOnErrorList, terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) {
	_init_.Initialize()
...
func (j *jsiiProxy_UserParametersTransactionAbortOnErrorList)SetTerraformResource(val cdktn.IInterpolatingParent) {
...
func (u *jsiiProxy_UserParametersTransactionAbortOnErrorList) AllWithMapKey(mapKeyAttributeName *string) cdktn.DynamicListTerraformIterator {
...
func (u *jsiiProxy_UserParametersTransactionAbortOnErrorList) Resolve(context cdktn.IResolveContext) interface{} {
