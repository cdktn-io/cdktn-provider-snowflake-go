...
func (j *jsiiProxy_UserShowOutputList) TerraformResource() cdktn.IInterpolatingParent {
...
func NewUserShowOutputList(terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) UserShowOutputList {
	_init_.Initialize()
...
func NewUserShowOutputList_Override(u UserShowOutputList, terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) {
	_init_.Initialize()
...
func (j *jsiiProxy_UserShowOutputList)SetTerraformResource(val cdktn.IInterpolatingParent) {
...
func (u *jsiiProxy_UserShowOutputList) AllWithMapKey(mapKeyAttributeName *string) cdktn.DynamicListTerraformIterator {
...
func (u *jsiiProxy_UserShowOutputList) Resolve(context cdktn.IResolveContext) interface{} {
