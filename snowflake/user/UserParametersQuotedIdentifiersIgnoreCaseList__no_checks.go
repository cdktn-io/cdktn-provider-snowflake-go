...
func (u *jsiiProxy_UserParametersQuotedIdentifiersIgnoreCaseList) validateResolveParameters(context cdktn.IResolveContext) error {
	return nil
}
...
func (j *jsiiProxy_UserParametersQuotedIdentifiersIgnoreCaseList) validateSetTerraformResourceParameters(val cdktn.IInterpolatingParent) error {
	return nil
}
...
func validateNewUserParametersQuotedIdentifiersIgnoreCaseListParameters(terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) error {
	return nil
}
