...
func (j *jsiiProxy_User) LogEventLevel() *string {
	var returns *string
	_jsii_.Get(
		j,
		"logEventLevel",
...
func (j *jsiiProxy_User) LogEventLevelInput() *string {
	var returns *string
	_jsii_.Get(
		j,
		"logEventLevelInput",
...
func (j *jsiiProxy_User)SetLogEventLevel(val *string) {
...
func (u *jsiiProxy_User) ResetLogEventLevel() {
	_jsii_.InvokeVoid(
		u,
		"resetLogEventLevel",
		nil, // no parameters
