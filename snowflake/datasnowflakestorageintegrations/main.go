...
func init() {
	...
	_jsii_.RegisterStruct(
		...
		reflect.TypeOf((*DataSnowflakeStorageIntegrationsStorageIntegrationsDescribeOutput)(nil)).Elem(),
	)
	_jsii_.RegisterClass(
		...
		reflect.TypeOf((*DataSnowflakeStorageIntegrationsStorageIntegrationsDescribeOutputList)(nil)).Elem(),
		[]_jsii_.Member{
	...
	_jsii_.RegisterClass(
		...
		reflect.TypeOf((*DataSnowflakeStorageIntegrationsStorageIntegrationsDescribeOutputOutputReference)(nil)).Elem(),
		[]_jsii_.Member{
	...
	_jsii_.RegisterStruct(
		...
		reflect.TypeOf((*DataSnowflakeStorageIntegrationsStorageIntegrationsShowOutput)(nil)).Elem(),
	)
	_jsii_.RegisterClass(
		...
		reflect.TypeOf((*DataSnowflakeStorageIntegrationsStorageIntegrationsShowOutputList)(nil)).Elem(),
		[]_jsii_.Member{
			_jsii_.MemberMethod{JsiiMethod: "allWithMapKey", GoMethod: "AllWithMapKey"},
			_jsii_.MemberMethod{JsiiMethod: "computeFqn", GoMethod: "ComputeFqn"},
			_jsii_.MemberProperty{JsiiProperty: "creationStack", GoGetter: "CreationStack"},
	...
	_jsii_.RegisterClass(
		...
		reflect.TypeOf((*DataSnowflakeStorageIntegrationsStorageIntegrationsShowOutputOutputReference)(nil)).Elem(),
		[]_jsii_.Member{
