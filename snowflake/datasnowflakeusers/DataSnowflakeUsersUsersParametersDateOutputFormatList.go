...
func (j *jsiiProxy_DataSnowflakeUsersUsersParametersDateOutputFormatList) TerraformResource() cdktn.IInterpolatingParent {
...
func NewDataSnowflakeUsersUsersParametersDateOutputFormatList(terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) DataSnowflakeUsersUsersParametersDateOutputFormatList {
	_init_.Initialize()
...
func NewDataSnowflakeUsersUsersParametersDateOutputFormatList_Override(d DataSnowflakeUsersUsersParametersDateOutputFormatList, terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) {
	_init_.Initialize()
...
func (j *jsiiProxy_DataSnowflakeUsersUsersParametersDateOutputFormatList)SetTerraformResource(val cdktn.IInterpolatingParent) {
...
func (d *jsiiProxy_DataSnowflakeUsersUsersParametersDateOutputFormatList) AllWithMapKey(mapKeyAttributeName *string) cdktn.DynamicListTerraformIterator {
...
func (d *jsiiProxy_DataSnowflakeUsersUsersParametersDateOutputFormatList) Resolve(context cdktn.IResolveContext) interface{} {
