...
func (j *jsiiProxy_DataSnowflakeUsersUsersParametersSimulatedDataSharingConsumerList) TerraformResource() cdktn.IInterpolatingParent {
...
func NewDataSnowflakeUsersUsersParametersSimulatedDataSharingConsumerList(terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) DataSnowflakeUsersUsersParametersSimulatedDataSharingConsumerList {
	_init_.Initialize()
...
func NewDataSnowflakeUsersUsersParametersSimulatedDataSharingConsumerList_Override(d DataSnowflakeUsersUsersParametersSimulatedDataSharingConsumerList, terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) {
	_init_.Initialize()
...
func (j *jsiiProxy_DataSnowflakeUsersUsersParametersSimulatedDataSharingConsumerList)SetTerraformResource(val cdktn.IInterpolatingParent) {
...
func (d *jsiiProxy_DataSnowflakeUsersUsersParametersSimulatedDataSharingConsumerList) AllWithMapKey(mapKeyAttributeName *string) cdktn.DynamicListTerraformIterator {
...
func (d *jsiiProxy_DataSnowflakeUsersUsersParametersSimulatedDataSharingConsumerList) Resolve(context cdktn.IResolveContext) interface{} {
