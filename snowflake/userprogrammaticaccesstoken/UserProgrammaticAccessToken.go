...
func (u *jsiiProxy_UserProgrammaticAccessToken) MarkWriteOnlyAttribute(value interface{}) interface{} {
...
func (u *jsiiProxy_UserProgrammaticAccessToken) RegisterProviderFeatureUsage(feature cdktn.ProviderFeature) {
...
func (u *jsiiProxy_UserProgrammaticAccessToken) With(mixins ...constructs.IMixin) constructs.IConstruct {
	args := []interface{}{}
