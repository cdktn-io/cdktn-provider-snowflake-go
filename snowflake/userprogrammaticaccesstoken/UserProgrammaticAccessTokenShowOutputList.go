...
import (
	...
	"github.com/cdktn-io/cdktn-provider-snowflake-go/snowflake/v17/userprogrammaticaccesstoken/internal"
...
func (j *jsiiProxy_UserProgrammaticAccessTokenShowOutputList) TerraformResource() cdktn.IInterpolatingParent {
...
func NewUserProgrammaticAccessTokenShowOutputList(terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) UserProgrammaticAccessTokenShowOutputList {
	_init_.Initialize()
...
func NewUserProgrammaticAccessTokenShowOutputList_Override(u UserProgrammaticAccessTokenShowOutputList, terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) {
	_init_.Initialize()
...
func (j *jsiiProxy_UserProgrammaticAccessTokenShowOutputList)SetTerraformResource(val cdktn.IInterpolatingParent) {
...
func (u *jsiiProxy_UserProgrammaticAccessTokenShowOutputList) AllWithMapKey(mapKeyAttributeName *string) cdktn.DynamicListTerraformIterator {
...
func (u *jsiiProxy_UserProgrammaticAccessTokenShowOutputList) Resolve(context cdktn.IResolveContext) interface{} {
