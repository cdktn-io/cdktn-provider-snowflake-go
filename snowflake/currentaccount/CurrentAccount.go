...
func (j *jsiiProxy_CurrentAccount) DefaultStreamlitComputePool() *string {
	var returns *string
	_jsii_.Get(
		j,
...
func (j *jsiiProxy_CurrentAccount) DefaultStreamlitComputePoolInput() *string {
	var returns *string
	_jsii_.Get(
		j,
...
func (j *jsiiProxy_CurrentAccount)SetDefaultStreamlitComputePool(val *string) {
...
func (c *jsiiProxy_CurrentAccount) MarkWriteOnlyAttribute(value interface{}) interface{} {
...
func (c *jsiiProxy_CurrentAccount) RegisterProviderFeatureUsage(feature cdktn.ProviderFeature) {
...
func (c *jsiiProxy_CurrentAccount) ResetDefaultStreamlitComputePool() {
	_jsii_.InvokeVoid(
		c,
		"resetDefaultStreamlitComputePool",
		nil, // no parameters
...
func (c *jsiiProxy_CurrentAccount) With(mixins ...constructs.IMixin) constructs.IConstruct {
	args := []interface{}{}
