...
type DataSnowflakeGrants interface {
	...
	SetId(val *string)
	IdInput() *string
	InheritedGrantsIn() DataSnowflakeGrantsInheritedGrantsInOutputReference
	InheritedGrantsInInput() *DataSnowflakeGrantsInheritedGrantsIn
	// Experimental.
	...
	PutInheritedGrantsIn(value *DataSnowflakeGrantsInheritedGrantsIn)
...
func (j *jsiiProxy_DataSnowflakeGrants) InheritedGrantsIn() DataSnowflakeGrantsInheritedGrantsInOutputReference {
	var returns DataSnowflakeGrantsInheritedGrantsInOutputReference
	_jsii_.Get(
		j,
		"inheritedGrantsIn",
		&returns,
...
func (j *jsiiProxy_DataSnowflakeGrants) InheritedGrantsInInput() *DataSnowflakeGrantsInheritedGrantsIn {
	var returns *DataSnowflakeGrantsInheritedGrantsIn
	_jsii_.Get(
		j,
		"inheritedGrantsInInput",
		&returns,
	)
	return returns
}
...
func (d *jsiiProxy_DataSnowflakeGrants) PutInheritedGrantsIn(value *DataSnowflakeGrantsInheritedGrantsIn) {
	if err := d.validatePutInheritedGrantsInParameters(value); err != nil {
		panic(err)
	}
	_jsii_.InvokeVoid(
		d,
		"putInheritedGrantsIn",
		[]interface{}{value},
	)
}

func (d *jsiiProxy_DataSnowflakeGrants) RegisterProviderFeatureUsage(feature cdktn.ProviderFeature) {
...
func (d *jsiiProxy_DataSnowflakeGrants) ResetInheritedGrantsIn() {
	_jsii_.InvokeVoid(
		d,
		"resetInheritedGrantsIn",
		nil, // no parameters
...
func (d *jsiiProxy_DataSnowflakeGrants) With(mixins ...constructs.IMixin) constructs.IConstruct {
	args := []interface{}{}
