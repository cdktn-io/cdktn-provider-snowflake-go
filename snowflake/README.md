# CDKTN Go bindings for snowflakedb/snowflake provider version 2.19.0

This repo builds and publishes the [Terraform snowflake provider](https://registry.terraform.io/providers/snowflakedb/snowflake/2.19.0/docs) bindings for [CDK Terrain](https://cdktn.io).
...
* [Terraform snowflake provider](https://registry.terraform.io/providers/snowflakedb/snowflake/2.19.0)
