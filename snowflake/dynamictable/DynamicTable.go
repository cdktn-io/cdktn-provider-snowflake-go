...
func (d *jsiiProxy_DynamicTable) MarkWriteOnlyAttribute(value interface{}) interface{} {
...
func (d *jsiiProxy_DynamicTable) RegisterProviderFeatureUsage(feature cdktn.ProviderFeature) {
...
func (d *jsiiProxy_DynamicTable) With(mixins ...constructs.IMixin) constructs.IConstruct {
	args := []interface{}{}
