...
func (w *jsiiProxy_Warehouse) MarkWriteOnlyAttribute(value interface{}) interface{} {
...
func (w *jsiiProxy_Warehouse) RegisterProviderFeatureUsage(feature cdktn.ProviderFeature) {
...
func (w *jsiiProxy_Warehouse) With(mixins ...constructs.IMixin) constructs.IConstruct {
	args := []interface{}{}
