...
func (j *jsiiProxy_WarehouseParametersStatementQueuedTimeoutInSecondsList) TerraformResource() cdktn.IInterpolatingParent {
...
func NewWarehouseParametersStatementQueuedTimeoutInSecondsList(terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) WarehouseParametersStatementQueuedTimeoutInSecondsList {
	_init_.Initialize()
...
func NewWarehouseParametersStatementQueuedTimeoutInSecondsList_Override(w WarehouseParametersStatementQueuedTimeoutInSecondsList, terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) {
	_init_.Initialize()
...
func (j *jsiiProxy_WarehouseParametersStatementQueuedTimeoutInSecondsList)SetTerraformResource(val cdktn.IInterpolatingParent) {
...
func (w *jsiiProxy_WarehouseParametersStatementQueuedTimeoutInSecondsList) AllWithMapKey(mapKeyAttributeName *string) cdktn.DynamicListTerraformIterator {
...
func (w *jsiiProxy_WarehouseParametersStatementQueuedTimeoutInSecondsList) Resolve(context cdktn.IResolveContext) interface{} {
