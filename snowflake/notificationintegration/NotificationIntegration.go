...
func (n *jsiiProxy_NotificationIntegration) MarkWriteOnlyAttribute(value interface{}) interface{} {
...
func (n *jsiiProxy_NotificationIntegration) RegisterProviderFeatureUsage(feature cdktn.ProviderFeature) {
...
func (n *jsiiProxy_NotificationIntegration) With(mixins ...constructs.IMixin) constructs.IConstruct {
	args := []interface{}{}
