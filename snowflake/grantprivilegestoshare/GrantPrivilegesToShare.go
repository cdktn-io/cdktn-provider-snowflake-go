...
func (g *jsiiProxy_GrantPrivilegesToShare) MarkWriteOnlyAttribute(value interface{}) interface{} {
...
func (g *jsiiProxy_GrantPrivilegesToShare) RegisterProviderFeatureUsage(feature cdktn.ProviderFeature) {
