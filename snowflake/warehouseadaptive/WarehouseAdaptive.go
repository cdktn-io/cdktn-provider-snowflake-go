...
func (j *jsiiProxy_WarehouseAdaptive) ResourceMonitor() *string {
	var returns *string
	_jsii_.Get(
		j,
		"resourceMonitor",
...
func (j *jsiiProxy_WarehouseAdaptive) ResourceMonitorInput() *string {
	var returns *string
	_jsii_.Get(
		j,
...
func (j *jsiiProxy_WarehouseAdaptive)SetResourceMonitor(val *string) {
...
func (w *jsiiProxy_WarehouseAdaptive) MarkWriteOnlyAttribute(value interface{}) interface{} {
...
func (w *jsiiProxy_WarehouseAdaptive) RegisterProviderFeatureUsage(feature cdktn.ProviderFeature) {
...
func (w *jsiiProxy_WarehouseAdaptive) ResetResourceMonitor() {
	_jsii_.InvokeVoid(
		w,
		"resetResourceMonitor",
		nil, // no parameters
