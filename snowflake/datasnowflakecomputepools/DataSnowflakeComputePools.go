...
func (d *jsiiProxy_DataSnowflakeComputePools) RegisterProviderFeatureUsage(feature cdktn.ProviderFeature) {
...
func (d *jsiiProxy_DataSnowflakeComputePools) With(mixins ...constructs.IMixin) constructs.IConstruct {
	args := []interface{}{}
