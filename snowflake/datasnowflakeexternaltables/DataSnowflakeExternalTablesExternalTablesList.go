...
func (j *jsiiProxy_DataSnowflakeExternalTablesExternalTablesList) TerraformResource() cdktn.IInterpolatingParent {
...
func NewDataSnowflakeExternalTablesExternalTablesList(terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) DataSnowflakeExternalTablesExternalTablesList {
	_init_.Initialize()
...
func NewDataSnowflakeExternalTablesExternalTablesList_Override(d DataSnowflakeExternalTablesExternalTablesList, terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) {
	_init_.Initialize()
...
func (j *jsiiProxy_DataSnowflakeExternalTablesExternalTablesList)SetTerraformResource(val cdktn.IInterpolatingParent) {
...
func (d *jsiiProxy_DataSnowflakeExternalTablesExternalTablesList) AllWithMapKey(mapKeyAttributeName *string) cdktn.DynamicListTerraformIterator {
...
func (d *jsiiProxy_DataSnowflakeExternalTablesExternalTablesList) Resolve(context cdktn.IResolveContext) interface{} {
