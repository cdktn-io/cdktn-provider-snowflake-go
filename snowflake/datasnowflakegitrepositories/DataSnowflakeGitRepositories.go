...
func (d *jsiiProxy_DataSnowflakeGitRepositories) RegisterProviderFeatureUsage(feature cdktn.ProviderFeature) {
...
func (d *jsiiProxy_DataSnowflakeGitRepositories) With(mixins ...constructs.IMixin) constructs.IConstruct {
	args := []interface{}{}
