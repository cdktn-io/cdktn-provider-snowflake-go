...
func (e *jsiiProxy_ExternalFunction) validateMarkWriteOnlyAttributeParameters(value interface{}) error {
	if value == nil {
		return fmt.Errorf("parameter value is required, but nil was provided")
	}
...
func (e *jsiiProxy_ExternalFunction) validatePutArgParameters(value interface{}) error {
	...
	default:
		if !_jsii_.IsAnonymousProxy(value) {
			return fmt.Errorf("parameter value must be one of the allowed types: cdktn.IResolvable, *[]*ExternalFunctionArg; received %#v (a %T)", value, value)
		}
	}
...
func (e *jsiiProxy_ExternalFunction) validatePutHeaderParameters(value interface{}) error {
	...
	default:
		if !_jsii_.IsAnonymousProxy(value) {
			return fmt.Errorf("parameter value must be one of the allowed types: cdktn.IResolvable, *[]*ExternalFunctionHeader; received %#v (a %T)", value, value)
		}
	}
...
func (e *jsiiProxy_ExternalFunction) validateRegisterProviderFeatureUsageParameters(feature cdktn.ProviderFeature) error {
	if feature == "" {
