...
func (s *jsiiProxy_StorageIntegration) MarkWriteOnlyAttribute(value interface{}) interface{} {
...
func (s *jsiiProxy_StorageIntegration) RegisterProviderFeatureUsage(feature cdktn.ProviderFeature) {
...
func (s *jsiiProxy_StorageIntegration) With(mixins ...constructs.IMixin) constructs.IConstruct {
	args := []interface{}{}
