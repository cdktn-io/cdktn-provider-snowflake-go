...
func init() {
	_jsii_.RegisterClass(
		...
		reflect.TypeOf((*CatalogIntegrationAwsGlue)(nil)).Elem(),
		[]_jsii_.Member{
			...
			_jsii_.MemberProperty{JsiiProperty: "glueAwsRoleArnInput", GoGetter: "GlueAwsRoleArnInput"},
			_jsii_.MemberProperty{JsiiProperty: "glueCatalogId", GoGetter: "GlueCatalogId"},
			_jsii_.MemberProperty{JsiiProperty: "glueCatalogIdInput", GoGetter: "GlueCatalogIdInput"},
			_jsii_.MemberProperty{JsiiProperty: "glueRegion", GoGetter: "GlueRegion"},
			_jsii_.MemberProperty{JsiiProperty: "glueRegionInput", GoGetter: "GlueRegionInput"},
			...
			_jsii_.MemberMethod{JsiiMethod: "resetGlueRegion", GoMethod: "ResetGlueRegion"},
	...
	_jsii_.RegisterStruct(
		...
		reflect.TypeOf((*CatalogIntegrationAwsGlueConfig)(nil)).Elem(),
	)
	_jsii_.RegisterStruct(
		"@cdktn/provider-snowflake.catalogIntegrationAwsGlue.CatalogIntegrationAwsGlueDescribeOutput",
		reflect.TypeOf((*CatalogIntegrationAwsGlueDescribeOutput)(nil)).Elem(),
	)
	_jsii_.RegisterClass(
		"@cdktn/provider-snowflake.catalogIntegrationAwsGlue.CatalogIntegrationAwsGlueDescribeOutputList",
		reflect.TypeOf((*CatalogIntegrationAwsGlueDescribeOutputList)(nil)).Elem(),
		[]_jsii_.Member{
	...
	_jsii_.RegisterClass(
		...
		reflect.TypeOf((*CatalogIntegrationAwsGlueDescribeOutputOutputReference)(nil)).Elem(),
		[]_jsii_.Member{
			_jsii_.MemberProperty{JsiiProperty: "catalogNamespace", GoGetter: "CatalogNamespace"},
			_jsii_.MemberProperty{JsiiProperty: "catalogSource", GoGetter: "CatalogSource"},
			_jsii_.MemberProperty{JsiiProperty: "comment", GoGetter: "Comment"},
	...
	_jsii_.RegisterStruct(
		...
		reflect.TypeOf((*CatalogIntegrationAwsGlueShowOutput)(nil)).Elem(),
	)
	_jsii_.RegisterClass(
		"@cdktn/provider-snowflake.catalogIntegrationAwsGlue.CatalogIntegrationAwsGlueShowOutputList",
		reflect.TypeOf((*CatalogIntegrationAwsGlueShowOutputList)(nil)).Elem(),
		[]_jsii_.Member{
			_jsii_.MemberMethod{JsiiMethod: "allWithMapKey", GoMethod: "AllWithMapKey"},
			_jsii_.MemberMethod{JsiiMethod: "computeFqn", GoMethod: "ComputeFqn"},
			_jsii_.MemberProperty{JsiiProperty: "creationStack", GoGetter: "CreationStack"},
	...
	_jsii_.RegisterClass(
		...
		reflect.TypeOf((*CatalogIntegrationAwsGlueShowOutputOutputReference)(nil)).Elem(),
		[]_jsii_.Member{
	...
	_jsii_.RegisterStruct(
		...
		reflect.TypeOf((*CatalogIntegrationAwsGlueTimeouts)(nil)).Elem(),
	)
	_jsii_.RegisterClass(
		"@cdktn/provider-snowflake.catalogIntegrationAwsGlue.CatalogIntegrationAwsGlueTimeoutsOutputReference",
		reflect.TypeOf((*CatalogIntegrationAwsGlueTimeoutsOutputReference)(nil)).Elem(),
		[]_jsii_.Member{
			_jsii_.MemberProperty{JsiiProperty: "complexObjectIndex", GoGetter: "ComplexObjectIndex"},
			_jsii_.MemberProperty{JsiiProperty: "complexObjectIsFromSet", GoGetter: "ComplexObjectIsFromSet"},
			_jsii_.MemberMethod{JsiiMethod: "computeFqn", GoMethod: "ComputeFqn"},
