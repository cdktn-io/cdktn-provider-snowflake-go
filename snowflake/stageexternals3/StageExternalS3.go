...
func (s *jsiiProxy_StageExternalS3) MarkWriteOnlyAttribute(value interface{}) interface{} {
...
func (s *jsiiProxy_StageExternalS3) RegisterProviderFeatureUsage(feature cdktn.ProviderFeature) {
