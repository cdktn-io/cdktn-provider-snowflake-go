...
func (j *jsiiProxy_NotebookFromList) Fqn() *string {
	var returns *string
	_jsii_.Get(
		j,
		"fqn",
...
func (j *jsiiProxy_NotebookFromList) InternalValue() interface{} {
...
func (j *jsiiProxy_NotebookFromList) TerraformAttribute() *string {
	var returns *string
	_jsii_.Get(
		j,
		"terraformAttribute",
...
func (j *jsiiProxy_NotebookFromList) WrapsSet() *bool {
	var returns *bool
	_jsii_.Get(
		j,
		"wrapsSet",
...
func (j *jsiiProxy_NotebookFromList)SetInternalValue(val interface{}) {
...
func (j *jsiiProxy_NotebookFromList)SetTerraformAttribute(val *string) {
...
func (j *jsiiProxy_NotebookFromList)SetWrapsSet(val *bool) {
...
func (n *jsiiProxy_NotebookFromList) ComputeFqn() *string {
	var returns *string
...
func (n *jsiiProxy_NotebookFromList) Get(index *float64) NotebookFromOutputReference {
	if err := n.validateGetParameters(index); err != nil {
		panic(err)
	}
	var returns NotebookFromOutputReference
...
func (n *jsiiProxy_NotebookFromList) ToString() *string {
	var returns *string
