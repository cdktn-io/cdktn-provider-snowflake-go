...
func (j *jsiiProxy_NotebookDescribeOutputList) TerraformResource() cdktn.IInterpolatingParent {
...
func NewNotebookDescribeOutputList(terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) NotebookDescribeOutputList {
	_init_.Initialize()
...
func NewNotebookDescribeOutputList_Override(n NotebookDescribeOutputList, terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) {
	_init_.Initialize()
...
func (j *jsiiProxy_NotebookDescribeOutputList)SetTerraformResource(val cdktn.IInterpolatingParent) {
...
func (n *jsiiProxy_NotebookDescribeOutputList) AllWithMapKey(mapKeyAttributeName *string) cdktn.DynamicListTerraformIterator {
...
func (n *jsiiProxy_NotebookDescribeOutputList) Resolve(context cdktn.IResolveContext) interface{} {
