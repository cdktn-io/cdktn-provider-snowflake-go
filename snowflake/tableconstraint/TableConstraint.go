...
func (t *jsiiProxy_TableConstraint) MarkWriteOnlyAttribute(value interface{}) interface{} {
...
func (t *jsiiProxy_TableConstraint) RegisterProviderFeatureUsage(feature cdktn.ProviderFeature) {
...
func (t *jsiiProxy_TableConstraint) With(mixins ...constructs.IMixin) constructs.IConstruct {
	args := []interface{}{}
