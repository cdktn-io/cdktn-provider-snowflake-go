...
import (
	...
	"github.com/cdktn-io/cdktn-provider-snowflake-go/snowflake/v18/shareddatabase/internal"
...
func (j *jsiiProxy_SharedDatabase) CdktfStack() cdktn.TerraformStack {
...
func (j *jsiiProxy_SharedDatabase) DefaultNotebookComputePoolCpu() *string {
	var returns *string
	_jsii_.Get(
		j,
...
func (j *jsiiProxy_SharedDatabase) DefaultNotebookComputePoolCpuInput() *string {
	var returns *string
	_jsii_.Get(
		j,
...
func (j *jsiiProxy_SharedDatabase) DefaultNotebookComputePoolGpu() *string {
	var returns *string
	_jsii_.Get(
		j,
...
func (j *jsiiProxy_SharedDatabase) DefaultNotebookComputePoolGpuInput() *string {
	var returns *string
	_jsii_.Get(
		j,
...
func (j *jsiiProxy_SharedDatabase) ForEach() cdktn.ITerraformIterator {
...
func (j *jsiiProxy_SharedDatabase) Lifecycle() *cdktn.TerraformResourceLifecycle {
...
func (j *jsiiProxy_SharedDatabase) Provider() cdktn.TerraformProvider {
...
func (j *jsiiProxy_SharedDatabase) TerraformGeneratorMetadata() *cdktn.TerraformProviderGeneratorMetadata {
...
func (j *jsiiProxy_SharedDatabase)SetDefaultNotebookComputePoolCpu(val *string) {
...
func (j *jsiiProxy_SharedDatabase)SetDefaultNotebookComputePoolGpu(val *string) {
...
func (j *jsiiProxy_SharedDatabase)SetForEach(val cdktn.ITerraformIterator) {
	_jsii_.Set(
		j,
		"forEach",
		val,
...
func (j *jsiiProxy_SharedDatabase)SetLifecycle(val *cdktn.TerraformResourceLifecycle) {
...
func (j *jsiiProxy_SharedDatabase)SetProvider(val cdktn.TerraformProvider) {
	_jsii_.Set(
		j,
		"provider",
		val,
...
func SharedDatabase_GenerateConfigForImport(scope constructs.Construct, importToId *string, importFromId *string, provider cdktn.TerraformProvider) cdktn.ImportableResource {
	_init_.Initialize()
...
func (s *jsiiProxy_SharedDatabase) GetBooleanAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (s *jsiiProxy_SharedDatabase) ImportFrom(id *string, provider cdktn.TerraformProvider) {
...
func (s *jsiiProxy_SharedDatabase) InterpolationForAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (s *jsiiProxy_SharedDatabase) MarkWriteOnlyAttribute(value interface{}) interface{} {
...
func (s *jsiiProxy_SharedDatabase) RegisterProviderFeatureUsage(feature cdktn.ProviderFeature) {
...
func (s *jsiiProxy_SharedDatabase) ResetDefaultNotebookComputePoolCpu() {
	_jsii_.InvokeVoid(
		s,
		"resetDefaultNotebookComputePoolCpu",
		nil, // no parameters
...
func (s *jsiiProxy_SharedDatabase) ResetDefaultNotebookComputePoolGpu() {
	_jsii_.InvokeVoid(
		s,
		"resetDefaultNotebookComputePoolGpu",
		nil, // no parameters
...
func (s *jsiiProxy_SharedDatabase) With(mixins ...constructs.IMixin) constructs.IConstruct {
	args := []interface{}{}
