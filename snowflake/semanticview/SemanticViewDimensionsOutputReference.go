...
func (j *jsiiProxy_SemanticViewDimensionsOutputReference) TerraformResource() cdktn.IInterpolatingParent {
...
func NewSemanticViewDimensionsOutputReference(terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, complexObjectIndex *float64, complexObjectIsFromSet *bool) SemanticViewDimensionsOutputReference {
	_init_.Initialize()
...
func NewSemanticViewDimensionsOutputReference_Override(s SemanticViewDimensionsOutputReference, terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, complexObjectIndex *float64, complexObjectIsFromSet *bool) {
	_init_.Initialize()
...
func (j *jsiiProxy_SemanticViewDimensionsOutputReference)SetTerraformResource(val cdktn.IInterpolatingParent) {
...
func (s *jsiiProxy_SemanticViewDimensionsOutputReference) GetBooleanAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (s *jsiiProxy_SemanticViewDimensionsOutputReference) InterpolationAsList() cdktn.IResolvable {
	var returns cdktn.IResolvable
...
func (s *jsiiProxy_SemanticViewDimensionsOutputReference) InterpolationForAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (s *jsiiProxy_SemanticViewDimensionsOutputReference) Resolve(context cdktn.IResolveContext) interface{} {
