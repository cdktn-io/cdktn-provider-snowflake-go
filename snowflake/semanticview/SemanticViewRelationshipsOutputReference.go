...
func (j *jsiiProxy_SemanticViewRelationshipsOutputReference) TerraformResource() cdktn.IInterpolatingParent {
...
func NewSemanticViewRelationshipsOutputReference(terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, complexObjectIndex *float64, complexObjectIsFromSet *bool) SemanticViewRelationshipsOutputReference {
	_init_.Initialize()
...
func NewSemanticViewRelationshipsOutputReference_Override(s SemanticViewRelationshipsOutputReference, terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, complexObjectIndex *float64, complexObjectIsFromSet *bool) {
	_init_.Initialize()
...
func (j *jsiiProxy_SemanticViewRelationshipsOutputReference)SetTerraformResource(val cdktn.IInterpolatingParent) {
...
func (s *jsiiProxy_SemanticViewRelationshipsOutputReference) GetBooleanAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (s *jsiiProxy_SemanticViewRelationshipsOutputReference) InterpolationAsList() cdktn.IResolvable {
	var returns cdktn.IResolvable
...
func (s *jsiiProxy_SemanticViewRelationshipsOutputReference) InterpolationForAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (s *jsiiProxy_SemanticViewRelationshipsOutputReference) Resolve(context cdktn.IResolveContext) interface{} {
