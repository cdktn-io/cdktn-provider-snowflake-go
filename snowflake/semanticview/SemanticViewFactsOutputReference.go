...
func (j *jsiiProxy_SemanticViewFactsOutputReference) TerraformResource() cdktf.IInterpolatingParent {
...
func NewSemanticViewFactsOutputReference(terraformResource cdktf.IInterpolatingParent, terraformAttribute *string, complexObjectIndex *float64, complexObjectIsFromSet *bool) SemanticViewFactsOutputReference {
	_init_.Initialize()
...
func NewSemanticViewFactsOutputReference_Override(s SemanticViewFactsOutputReference, terraformResource cdktf.IInterpolatingParent, terraformAttribute *string, complexObjectIndex *float64, complexObjectIsFromSet *bool) {
	_init_.Initialize()
...
func (j *jsiiProxy_SemanticViewFactsOutputReference)SetTerraformResource(val cdktf.IInterpolatingParent) {
...
func (s *jsiiProxy_SemanticViewFactsOutputReference) GetBooleanAttribute(terraformAttribute *string) cdktf.IResolvable {
...
func (s *jsiiProxy_SemanticViewFactsOutputReference) InterpolationAsList() cdktf.IResolvable {
	var returns cdktf.IResolvable
...
func (s *jsiiProxy_SemanticViewFactsOutputReference) InterpolationForAttribute(terraformAttribute *string) cdktf.IResolvable {
...
func (s *jsiiProxy_SemanticViewFactsOutputReference) Resolve(context cdktf.IResolveContext) interface{} {
