...
func (s *jsiiProxy_SemanticViewTablesOutputReference) validatePutUniqueParameters(value interface{}) error {
	...
	case *[]*SemanticViewTablesUnique:
		value := value.(*[]*SemanticViewTablesUnique)
	...
	case []*SemanticViewTablesUnique:
		value_ := value.([]*SemanticViewTablesUnique)
		value := &value_
		for idx_cd4240, v := range *value {
			if err := _jsii_.ValidateStruct(v, func() string { return fmt.Sprintf("parameter value[%#v]", idx_cd4240) }); err != nil {
				return err
	...
	default:
		if !_jsii_.IsAnonymousProxy(value) {
			return fmt.Errorf("parameter value must be one of the allowed types: cdktf.IResolvable, *[]*SemanticViewTablesUnique; received %#v (a %T)", value, value)
		}
	}
...
func (j *jsiiProxy_SemanticViewTablesOutputReference) validateSetInternalValueParameters(val interface{}) error {
	...
	case *SemanticViewTables:
		val := val.(*SemanticViewTables)
		if err := _jsii_.ValidateStruct(val, func() string { return "parameter val" }); err != nil {
			return err
		}
	case SemanticViewTables:
		val_ := val.(SemanticViewTables)
		val := &val_
		if err := _jsii_.ValidateStruct(val, func() string { return "parameter val" }); err != nil {
			return err
		}
	default:
		if !_jsii_.IsAnonymousProxy(val) {
			return fmt.Errorf("parameter val must be one of the allowed types: cdktf.IResolvable, *SemanticViewTables; received %#v (a %T)", val, val)
		}
	}
