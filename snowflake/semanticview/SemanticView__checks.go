...
func (s *jsiiProxy_SemanticView) validatePutDimensionsParameters(value interface{}) error {
	...
	case *[]*SemanticViewDimensions:
		value := value.(*[]*SemanticViewDimensions)
	...
	case []*SemanticViewDimensions:
		value_ := value.([]*SemanticViewDimensions)
		value := &value_
		for idx_cd4240, v := range *value {
			if err := _jsii_.ValidateStruct(v, func() string { return fmt.Sprintf("parameter value[%#v]", idx_cd4240) }); err != nil {
				return err
	...
	default:
		if !_jsii_.IsAnonymousProxy(value) {
			return fmt.Errorf("parameter value must be one of the allowed types: cdktn.IResolvable, *[]*SemanticViewDimensions; received %#v (a %T)", value, value)
		}
	}
...
func (s *jsiiProxy_SemanticView) validatePutFactsParameters(value interface{}) error {
	...
	case []*SemanticViewFacts:
		value_ := value.([]*SemanticViewFacts)
		value := &value_
		for idx_cd4240, v := range *value {
			if err := _jsii_.ValidateStruct(v, func() string { return fmt.Sprintf("parameter value[%#v]", idx_cd4240) }); err != nil {
				return err
	...
	default:
		if !_jsii_.IsAnonymousProxy(value) {
			return fmt.Errorf("parameter value must be one of the allowed types: cdktn.IResolvable, *[]*SemanticViewFacts; received %#v (a %T)", value, value)
		}
	}
...
func (s *jsiiProxy_SemanticView) validatePutMetricsParameters(value interface{}) error {
	...
	case *[]*SemanticViewMetrics:
		value := value.(*[]*SemanticViewMetrics)
		for idx_cd4240, v := range *value {
			if err := _jsii_.ValidateStruct(v, func() string { return fmt.Sprintf("parameter value[%#v]", idx_cd4240) }); err != nil {
				return err
			}
	...
	case []*SemanticViewMetrics:
		value_ := value.([]*SemanticViewMetrics)
		value := &value_
		for idx_cd4240, v := range *value {
			if err := _jsii_.ValidateStruct(v, func() string { return fmt.Sprintf("parameter value[%#v]", idx_cd4240) }); err != nil {
				return err
	...
	default:
		if !_jsii_.IsAnonymousProxy(value) {
			return fmt.Errorf("parameter value must be one of the allowed types: cdktn.IResolvable, *[]*SemanticViewMetrics; received %#v (a %T)", value, value)
		}
	}
...
func (s *jsiiProxy_SemanticView) validatePutRelationshipsParameters(value interface{}) error {
	...
	case *[]*SemanticViewRelationships:
		value := value.(*[]*SemanticViewRelationships)
		for idx_cd4240, v := range *value {
			if err := _jsii_.ValidateStruct(v, func() string { return fmt.Sprintf("parameter value[%#v]", idx_cd4240) }); err != nil {
				return err
			}
	...
	case []*SemanticViewRelationships:
		value_ := value.([]*SemanticViewRelationships)
		value := &value_
		for idx_cd4240, v := range *value {
			if err := _jsii_.ValidateStruct(v, func() string { return fmt.Sprintf("parameter value[%#v]", idx_cd4240) }); err != nil {
				return err
	...
	default:
		if !_jsii_.IsAnonymousProxy(value) {
			return fmt.Errorf("parameter value must be one of the allowed types: cdktn.IResolvable, *[]*SemanticViewRelationships; received %#v (a %T)", value, value)
		}
	}
...
func (s *jsiiProxy_SemanticView) validatePutTablesParameters(value interface{}) error {
	...
	case cdktn.IResolvable:
		// ok
	case *[]*SemanticViewTables:
		value := value.(*[]*SemanticViewTables)
		for idx_cd4240, v := range *value {
			if err := _jsii_.ValidateStruct(v, func() string { return fmt.Sprintf("parameter value[%#v]", idx_cd4240) }); err != nil {
				return err
			}
	...
	case []*SemanticViewTables:
		value_ := value.([]*SemanticViewTables)
		value := &value_
		for idx_cd4240, v := range *value {
			if err := _jsii_.ValidateStruct(v, func() string { return fmt.Sprintf("parameter value[%#v]", idx_cd4240) }); err != nil {
				return err
	...
	default:
		if !_jsii_.IsAnonymousProxy(value) {
			return fmt.Errorf("parameter value must be one of the allowed types: cdktn.IResolvable, *[]*SemanticViewTables; received %#v (a %T)", value, value)
		}
	}
...
func (j *jsiiProxy_SemanticView) validateSetLifecycleParameters(val *cdktn.TerraformResourceLifecycle) error {
	if err := _jsii_.ValidateStruct(val, func() string { return "parameter val" }); err != nil {
		return err
	}
