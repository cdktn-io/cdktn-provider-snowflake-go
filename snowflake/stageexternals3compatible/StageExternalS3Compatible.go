...
func (s *jsiiProxy_StageExternalS3Compatible) MarkWriteOnlyAttribute(value interface{}) interface{} {
...
func (s *jsiiProxy_StageExternalS3Compatible) RegisterProviderFeatureUsage(feature cdktn.ProviderFeature) {
...
func (s *jsiiProxy_StageExternalS3Compatible) With(mixins ...constructs.IMixin) constructs.IConstruct {
	args := []interface{}{}
