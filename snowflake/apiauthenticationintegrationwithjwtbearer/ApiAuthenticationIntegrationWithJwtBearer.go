...
func (a *jsiiProxy_ApiAuthenticationIntegrationWithJwtBearer) MarkWriteOnlyAttribute(value interface{}) interface{} {
...
func (a *jsiiProxy_ApiAuthenticationIntegrationWithJwtBearer) RegisterProviderFeatureUsage(feature cdktn.ProviderFeature) {
...
func (a *jsiiProxy_ApiAuthenticationIntegrationWithJwtBearer) With(mixins ...constructs.IMixin) constructs.IConstruct {
	args := []interface{}{}
