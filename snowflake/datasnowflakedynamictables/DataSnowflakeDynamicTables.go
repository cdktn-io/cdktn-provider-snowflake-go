...
func (d *jsiiProxy_DataSnowflakeDynamicTables) RegisterProviderFeatureUsage(feature cdktn.ProviderFeature) {
...
func (d *jsiiProxy_DataSnowflakeDynamicTables) With(mixins ...constructs.IMixin) constructs.IConstruct {
	args := []interface{}{}
