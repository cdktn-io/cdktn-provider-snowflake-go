...
func (j *jsiiProxy_DataSnowflakeDynamicTablesRecordsList) TerraformResource() cdktn.IInterpolatingParent {
...
func NewDataSnowflakeDynamicTablesRecordsList(terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) DataSnowflakeDynamicTablesRecordsList {
	_init_.Initialize()
...
func NewDataSnowflakeDynamicTablesRecordsList_Override(d DataSnowflakeDynamicTablesRecordsList, terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) {
	_init_.Initialize()
...
func (j *jsiiProxy_DataSnowflakeDynamicTablesRecordsList)SetTerraformResource(val cdktn.IInterpolatingParent) {
...
func (d *jsiiProxy_DataSnowflakeDynamicTablesRecordsList) AllWithMapKey(mapKeyAttributeName *string) cdktn.DynamicListTerraformIterator {
...
func (d *jsiiProxy_DataSnowflakeDynamicTablesRecordsList) Resolve(context cdktn.IResolveContext) interface{} {
