...
func (g *jsiiProxy_GrantPrivilegesToAccountRole) MarkWriteOnlyAttribute(value interface{}) interface{} {
...
func (g *jsiiProxy_GrantPrivilegesToAccountRole) RegisterProviderFeatureUsage(feature cdktn.ProviderFeature) {
