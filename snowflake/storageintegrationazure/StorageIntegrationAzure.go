...
func (s *jsiiProxy_StorageIntegrationAzure) MarkWriteOnlyAttribute(value interface{}) interface{} {
...
func (s *jsiiProxy_StorageIntegrationAzure) RegisterProviderFeatureUsage(feature cdktn.ProviderFeature) {
...
func (s *jsiiProxy_StorageIntegrationAzure) With(mixins ...constructs.IMixin) constructs.IConstruct {
	args := []interface{}{}
