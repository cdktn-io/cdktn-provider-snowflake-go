...
func (j *jsiiProxy_DataSnowflakeExternalVolumesExternalVolumesDescribeOutputStorageLocationsAzureStorageLocationOutputReference) UsePrivatelinkEndpoint() *string {
	var returns *string
	_jsii_.Get(
		j,
