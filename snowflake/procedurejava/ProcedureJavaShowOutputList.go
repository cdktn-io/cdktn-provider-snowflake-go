...
func (j *jsiiProxy_ProcedureJavaShowOutputList) TerraformResource() cdktn.IInterpolatingParent {
...
func NewProcedureJavaShowOutputList(terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) ProcedureJavaShowOutputList {
	_init_.Initialize()
...
func NewProcedureJavaShowOutputList_Override(p ProcedureJavaShowOutputList, terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) {
	_init_.Initialize()
...
func (j *jsiiProxy_ProcedureJavaShowOutputList)SetTerraformResource(val cdktn.IInterpolatingParent) {
...
func (p *jsiiProxy_ProcedureJavaShowOutputList) AllWithMapKey(mapKeyAttributeName *string) cdktn.DynamicListTerraformIterator {
...
func (p *jsiiProxy_ProcedureJavaShowOutputList) Resolve(context cdktn.IResolveContext) interface{} {
