...
func (j *jsiiProxy_ProcedureJavaParametersEnableConsoleOutputList) TerraformResource() cdktn.IInterpolatingParent {
...
func NewProcedureJavaParametersEnableConsoleOutputList(terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) ProcedureJavaParametersEnableConsoleOutputList {
	_init_.Initialize()
...
func NewProcedureJavaParametersEnableConsoleOutputList_Override(p ProcedureJavaParametersEnableConsoleOutputList, terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) {
	_init_.Initialize()
...
func (j *jsiiProxy_ProcedureJavaParametersEnableConsoleOutputList)SetTerraformResource(val cdktn.IInterpolatingParent) {
...
func (p *jsiiProxy_ProcedureJavaParametersEnableConsoleOutputList) AllWithMapKey(mapKeyAttributeName *string) cdktn.DynamicListTerraformIterator {
...
func (p *jsiiProxy_ProcedureJavaParametersEnableConsoleOutputList) Resolve(context cdktn.IResolveContext) interface{} {
