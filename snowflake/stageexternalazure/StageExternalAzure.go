...
func (s *jsiiProxy_StageExternalAzure) MarkWriteOnlyAttribute(value interface{}) interface{} {
...
func (s *jsiiProxy_StageExternalAzure) RegisterProviderFeatureUsage(feature cdktn.ProviderFeature) {
