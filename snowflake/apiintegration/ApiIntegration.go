...
func (a *jsiiProxy_ApiIntegration) MarkWriteOnlyAttribute(value interface{}) interface{} {
...
func (a *jsiiProxy_ApiIntegration) RegisterProviderFeatureUsage(feature cdktn.ProviderFeature) {
...
func (a *jsiiProxy_ApiIntegration) With(mixins ...constructs.IMixin) constructs.IConstruct {
	args := []interface{}{}
