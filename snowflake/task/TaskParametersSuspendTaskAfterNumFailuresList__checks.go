...
func (t *jsiiProxy_TaskParametersSuspendTaskAfterNumFailuresList) validateResolveParameters(context cdktn.IResolveContext) error {
	if context == nil {
...
func (j *jsiiProxy_TaskParametersSuspendTaskAfterNumFailuresList) validateSetTerraformResourceParameters(val cdktn.IInterpolatingParent) error {
	if val == nil {
		return fmt.Errorf("parameter val is required, but nil was provided")
	}
...
func validateNewTaskParametersSuspendTaskAfterNumFailuresListParameters(terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) error {
