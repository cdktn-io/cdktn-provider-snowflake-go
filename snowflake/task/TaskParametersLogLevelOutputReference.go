...
func (j *jsiiProxy_TaskParametersLogLevelOutputReference) TerraformResource() cdktn.IInterpolatingParent {
...
func NewTaskParametersLogLevelOutputReference(terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, complexObjectIndex *float64, complexObjectIsFromSet *bool) TaskParametersLogLevelOutputReference {
	_init_.Initialize()
...
func NewTaskParametersLogLevelOutputReference_Override(t TaskParametersLogLevelOutputReference, terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, complexObjectIndex *float64, complexObjectIsFromSet *bool) {
	_init_.Initialize()
...
func (j *jsiiProxy_TaskParametersLogLevelOutputReference)SetTerraformResource(val cdktn.IInterpolatingParent) {
...
func (t *jsiiProxy_TaskParametersLogLevelOutputReference) GetBooleanAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (t *jsiiProxy_TaskParametersLogLevelOutputReference) InterpolationAsList() cdktn.IResolvable {
	var returns cdktn.IResolvable
...
func (t *jsiiProxy_TaskParametersLogLevelOutputReference) InterpolationForAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (t *jsiiProxy_TaskParametersLogLevelOutputReference) Resolve(context cdktn.IResolveContext) interface{} {
