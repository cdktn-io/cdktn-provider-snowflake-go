...
func (j *jsiiProxy_TaskParametersGeometryOutputFormatList) TerraformResource() cdktn.IInterpolatingParent {
...
func NewTaskParametersGeometryOutputFormatList(terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) TaskParametersGeometryOutputFormatList {
	_init_.Initialize()
...
func NewTaskParametersGeometryOutputFormatList_Override(t TaskParametersGeometryOutputFormatList, terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) {
	_init_.Initialize()
...
func (j *jsiiProxy_TaskParametersGeometryOutputFormatList)SetTerraformResource(val cdktn.IInterpolatingParent) {
...
func (t *jsiiProxy_TaskParametersGeometryOutputFormatList) AllWithMapKey(mapKeyAttributeName *string) cdktn.DynamicListTerraformIterator {
...
func (t *jsiiProxy_TaskParametersGeometryOutputFormatList) Resolve(context cdktn.IResolveContext) interface{} {
