...
func (j *jsiiProxy_TaskParametersTaskAutoRetryAttemptsList) TerraformResource() cdktn.IInterpolatingParent {
...
func NewTaskParametersTaskAutoRetryAttemptsList(terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) TaskParametersTaskAutoRetryAttemptsList {
	_init_.Initialize()
...
func NewTaskParametersTaskAutoRetryAttemptsList_Override(t TaskParametersTaskAutoRetryAttemptsList, terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) {
	_init_.Initialize()
...
func (j *jsiiProxy_TaskParametersTaskAutoRetryAttemptsList)SetTerraformResource(val cdktn.IInterpolatingParent) {
...
func (t *jsiiProxy_TaskParametersTaskAutoRetryAttemptsList) AllWithMapKey(mapKeyAttributeName *string) cdktn.DynamicListTerraformIterator {
...
func (t *jsiiProxy_TaskParametersTaskAutoRetryAttemptsList) Resolve(context cdktn.IResolveContext) interface{} {
