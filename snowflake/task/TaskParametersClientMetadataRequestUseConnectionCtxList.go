...
func (j *jsiiProxy_TaskParametersClientMetadataRequestUseConnectionCtxList) TerraformResource() cdktn.IInterpolatingParent {
...
func NewTaskParametersClientMetadataRequestUseConnectionCtxList(terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) TaskParametersClientMetadataRequestUseConnectionCtxList {
	_init_.Initialize()
...
func NewTaskParametersClientMetadataRequestUseConnectionCtxList_Override(t TaskParametersClientMetadataRequestUseConnectionCtxList, terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) {
	_init_.Initialize()
...
func (j *jsiiProxy_TaskParametersClientMetadataRequestUseConnectionCtxList)SetTerraformResource(val cdktn.IInterpolatingParent) {
...
func (t *jsiiProxy_TaskParametersClientMetadataRequestUseConnectionCtxList) AllWithMapKey(mapKeyAttributeName *string) cdktn.DynamicListTerraformIterator {
...
func (t *jsiiProxy_TaskParametersClientMetadataRequestUseConnectionCtxList) Resolve(context cdktn.IResolveContext) interface{} {
