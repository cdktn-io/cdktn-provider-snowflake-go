...
type TaskConfig struct {
	...
	// Specifies the maximum warehouse size for serverless tasks.
	//
	...
	// Specifies the minimum warehouse size for serverless tasks.
	//
	...
	TargetCompletionInterval *TaskTargetCompletionInterval `field:"optional" json:"targetCompletionInterval" yaml:"targetCompletionInterval"`
