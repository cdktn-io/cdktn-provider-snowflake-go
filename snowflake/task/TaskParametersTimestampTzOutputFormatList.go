...
func (j *jsiiProxy_TaskParametersTimestampTzOutputFormatList) TerraformResource() cdktn.IInterpolatingParent {
...
func NewTaskParametersTimestampTzOutputFormatList(terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) TaskParametersTimestampTzOutputFormatList {
	_init_.Initialize()
...
func NewTaskParametersTimestampTzOutputFormatList_Override(t TaskParametersTimestampTzOutputFormatList, terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) {
	_init_.Initialize()
...
func (j *jsiiProxy_TaskParametersTimestampTzOutputFormatList)SetTerraformResource(val cdktn.IInterpolatingParent) {
...
func (t *jsiiProxy_TaskParametersTimestampTzOutputFormatList) AllWithMapKey(mapKeyAttributeName *string) cdktn.DynamicListTerraformIterator {
...
func (t *jsiiProxy_TaskParametersTimestampTzOutputFormatList) Resolve(context cdktn.IResolveContext) interface{} {
