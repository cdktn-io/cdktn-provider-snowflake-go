...
import (
	...
	"github.com/cdktn-io/cdktn-provider-snowflake-go/snowflake/v18/failovergroup/internal"
...
func (j *jsiiProxy_FailoverGroup) CdktfStack() cdktn.TerraformStack {
...
func (j *jsiiProxy_FailoverGroup) ForEach() cdktn.ITerraformIterator {
...
func (j *jsiiProxy_FailoverGroup) Lifecycle() *cdktn.TerraformResourceLifecycle {
...
func (j *jsiiProxy_FailoverGroup) Provider() cdktn.TerraformProvider {
...
func (j *jsiiProxy_FailoverGroup) TerraformGeneratorMetadata() *cdktn.TerraformProviderGeneratorMetadata {
...
func (j *jsiiProxy_FailoverGroup)SetForEach(val cdktn.ITerraformIterator) {
	_jsii_.Set(
		j,
		"forEach",
		val,
...
func (j *jsiiProxy_FailoverGroup)SetLifecycle(val *cdktn.TerraformResourceLifecycle) {
...
func (j *jsiiProxy_FailoverGroup)SetProvider(val cdktn.TerraformProvider) {
	_jsii_.Set(
		j,
		"provider",
		val,
...
func FailoverGroup_GenerateConfigForImport(scope constructs.Construct, importToId *string, importFromId *string, provider cdktn.TerraformProvider) cdktn.ImportableResource {
	_init_.Initialize()
...
func (f *jsiiProxy_FailoverGroup) GetBooleanAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (f *jsiiProxy_FailoverGroup) ImportFrom(id *string, provider cdktn.TerraformProvider) {
...
func (f *jsiiProxy_FailoverGroup) InterpolationForAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (f *jsiiProxy_FailoverGroup) MarkWriteOnlyAttribute(value interface{}) interface{} {
...
func (f *jsiiProxy_FailoverGroup) RegisterProviderFeatureUsage(feature cdktn.ProviderFeature) {
...
func (f *jsiiProxy_FailoverGroup) With(mixins ...constructs.IMixin) constructs.IConstruct {
	args := []interface{}{}
