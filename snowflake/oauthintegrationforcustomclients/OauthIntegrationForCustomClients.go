...
func (j *jsiiProxy_OauthIntegrationForCustomClients) AllowedRolesList() *[]*string {
	var returns *[]*string
	_jsii_.Get(
		j,
		"allowedRolesList",
...
func (j *jsiiProxy_OauthIntegrationForCustomClients) AllowedRolesListInput() *[]*string {
	var returns *[]*string
	_jsii_.Get(
		j,
...
func (j *jsiiProxy_OauthIntegrationForCustomClients)SetAllowedRolesList(val *[]*string) {
...
func (o *jsiiProxy_OauthIntegrationForCustomClients) MarkWriteOnlyAttribute(value interface{}) interface{} {
...
func (o *jsiiProxy_OauthIntegrationForCustomClients) RegisterProviderFeatureUsage(feature cdktn.ProviderFeature) {
...
func (o *jsiiProxy_OauthIntegrationForCustomClients) ResetAllowedRolesList() {
	_jsii_.InvokeVoid(
		o,
		"resetAllowedRolesList",
		nil, // no parameters
...
func (o *jsiiProxy_OauthIntegrationForCustomClients) With(mixins ...constructs.IMixin) constructs.IConstruct {
	args := []interface{}{}
