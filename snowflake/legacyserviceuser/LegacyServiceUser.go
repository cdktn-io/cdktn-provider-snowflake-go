...
func (l *jsiiProxy_LegacyServiceUser) MarkWriteOnlyAttribute(value interface{}) interface{} {
...
func (l *jsiiProxy_LegacyServiceUser) RegisterProviderFeatureUsage(feature cdktn.ProviderFeature) {
