...
func (l *jsiiProxy_LegacyServiceUserParametersClientPrefetchThreadsList) validateResolveParameters(context cdktn.IResolveContext) error {
	if context == nil {
...
func (j *jsiiProxy_LegacyServiceUserParametersClientPrefetchThreadsList) validateSetTerraformResourceParameters(val cdktn.IInterpolatingParent) error {
	if val == nil {
		return fmt.Errorf("parameter val is required, but nil was provided")
	}
...
func validateNewLegacyServiceUserParametersClientPrefetchThreadsListParameters(terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) error {
