...
func (j *jsiiProxy_LegacyServiceUserParametersClientSessionKeepAliveHeartbeatFrequencyList) TerraformResource() cdktn.IInterpolatingParent {
...
func NewLegacyServiceUserParametersClientSessionKeepAliveHeartbeatFrequencyList(terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) LegacyServiceUserParametersClientSessionKeepAliveHeartbeatFrequencyList {
	_init_.Initialize()
...
func NewLegacyServiceUserParametersClientSessionKeepAliveHeartbeatFrequencyList_Override(l LegacyServiceUserParametersClientSessionKeepAliveHeartbeatFrequencyList, terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) {
	_init_.Initialize()
...
func (j *jsiiProxy_LegacyServiceUserParametersClientSessionKeepAliveHeartbeatFrequencyList)SetTerraformResource(val cdktn.IInterpolatingParent) {
...
func (l *jsiiProxy_LegacyServiceUserParametersClientSessionKeepAliveHeartbeatFrequencyList) AllWithMapKey(mapKeyAttributeName *string) cdktn.DynamicListTerraformIterator {
...
func (l *jsiiProxy_LegacyServiceUserParametersClientSessionKeepAliveHeartbeatFrequencyList) Resolve(context cdktn.IResolveContext) interface{} {
