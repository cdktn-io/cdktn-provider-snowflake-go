...
func (j *jsiiProxy_LegacyServiceUserParametersJdbcTreatDecimalAsIntList) TerraformResource() cdktn.IInterpolatingParent {
...
func NewLegacyServiceUserParametersJdbcTreatDecimalAsIntList(terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) LegacyServiceUserParametersJdbcTreatDecimalAsIntList {
	_init_.Initialize()
...
func NewLegacyServiceUserParametersJdbcTreatDecimalAsIntList_Override(l LegacyServiceUserParametersJdbcTreatDecimalAsIntList, terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) {
	_init_.Initialize()
...
func (j *jsiiProxy_LegacyServiceUserParametersJdbcTreatDecimalAsIntList)SetTerraformResource(val cdktn.IInterpolatingParent) {
...
func (l *jsiiProxy_LegacyServiceUserParametersJdbcTreatDecimalAsIntList) AllWithMapKey(mapKeyAttributeName *string) cdktn.DynamicListTerraformIterator {
...
func (l *jsiiProxy_LegacyServiceUserParametersJdbcTreatDecimalAsIntList) Resolve(context cdktn.IResolveContext) interface{} {
