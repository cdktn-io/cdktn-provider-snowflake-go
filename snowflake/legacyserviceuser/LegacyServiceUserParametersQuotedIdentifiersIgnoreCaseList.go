...
func (j *jsiiProxy_LegacyServiceUserParametersQuotedIdentifiersIgnoreCaseList) TerraformResource() cdktn.IInterpolatingParent {
...
func NewLegacyServiceUserParametersQuotedIdentifiersIgnoreCaseList(terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) LegacyServiceUserParametersQuotedIdentifiersIgnoreCaseList {
	_init_.Initialize()
...
func NewLegacyServiceUserParametersQuotedIdentifiersIgnoreCaseList_Override(l LegacyServiceUserParametersQuotedIdentifiersIgnoreCaseList, terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) {
	_init_.Initialize()
...
func (j *jsiiProxy_LegacyServiceUserParametersQuotedIdentifiersIgnoreCaseList)SetTerraformResource(val cdktn.IInterpolatingParent) {
...
func (l *jsiiProxy_LegacyServiceUserParametersQuotedIdentifiersIgnoreCaseList) AllWithMapKey(mapKeyAttributeName *string) cdktn.DynamicListTerraformIterator {
...
func (l *jsiiProxy_LegacyServiceUserParametersQuotedIdentifiersIgnoreCaseList) Resolve(context cdktn.IResolveContext) interface{} {
