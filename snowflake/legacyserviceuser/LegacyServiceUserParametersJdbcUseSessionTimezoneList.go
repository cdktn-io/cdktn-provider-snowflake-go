...
func (j *jsiiProxy_LegacyServiceUserParametersJdbcUseSessionTimezoneList) TerraformResource() cdktn.IInterpolatingParent {
...
func NewLegacyServiceUserParametersJdbcUseSessionTimezoneList(terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) LegacyServiceUserParametersJdbcUseSessionTimezoneList {
	_init_.Initialize()
...
func NewLegacyServiceUserParametersJdbcUseSessionTimezoneList_Override(l LegacyServiceUserParametersJdbcUseSessionTimezoneList, terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) {
	_init_.Initialize()
...
func (j *jsiiProxy_LegacyServiceUserParametersJdbcUseSessionTimezoneList)SetTerraformResource(val cdktn.IInterpolatingParent) {
...
func (l *jsiiProxy_LegacyServiceUserParametersJdbcUseSessionTimezoneList) AllWithMapKey(mapKeyAttributeName *string) cdktn.DynamicListTerraformIterator {
...
func (l *jsiiProxy_LegacyServiceUserParametersJdbcUseSessionTimezoneList) Resolve(context cdktn.IResolveContext) interface{} {
