...
func (j *jsiiProxy_DataSnowflakeDatabaseRolesDatabaseRolesShowOutputList) TerraformResource() cdktn.IInterpolatingParent {
...
func NewDataSnowflakeDatabaseRolesDatabaseRolesShowOutputList(terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) DataSnowflakeDatabaseRolesDatabaseRolesShowOutputList {
	_init_.Initialize()
...
func NewDataSnowflakeDatabaseRolesDatabaseRolesShowOutputList_Override(d DataSnowflakeDatabaseRolesDatabaseRolesShowOutputList, terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) {
	_init_.Initialize()
...
func (j *jsiiProxy_DataSnowflakeDatabaseRolesDatabaseRolesShowOutputList)SetTerraformResource(val cdktn.IInterpolatingParent) {
...
func (d *jsiiProxy_DataSnowflakeDatabaseRolesDatabaseRolesShowOutputList) AllWithMapKey(mapKeyAttributeName *string) cdktn.DynamicListTerraformIterator {
...
func (d *jsiiProxy_DataSnowflakeDatabaseRolesDatabaseRolesShowOutputList) Resolve(context cdktn.IResolveContext) interface{} {
