...
func (d *jsiiProxy_DataSnowflakeDatabaseRoles) RegisterProviderFeatureUsage(feature cdktn.ProviderFeature) {
...
func (d *jsiiProxy_DataSnowflakeDatabaseRoles) With(mixins ...constructs.IMixin) constructs.IConstruct {
	args := []interface{}{}
