...
func (j *jsiiProxy_FunctionPython) CdktfStack() cdktn.TerraformStack {
...
func (j *jsiiProxy_FunctionPython) ForEach() cdktn.ITerraformIterator {
...
func (j *jsiiProxy_FunctionPython) Lifecycle() *cdktn.TerraformResourceLifecycle {
...
func (j *jsiiProxy_FunctionPython) Provider() cdktn.TerraformProvider {
...
func (j *jsiiProxy_FunctionPython) TerraformGeneratorMetadata() *cdktn.TerraformProviderGeneratorMetadata {
...
func (j *jsiiProxy_FunctionPython)SetForEach(val cdktn.ITerraformIterator) {
	_jsii_.Set(
		j,
		"forEach",
		val,
...
func (j *jsiiProxy_FunctionPython)SetLifecycle(val *cdktn.TerraformResourceLifecycle) {
...
func (j *jsiiProxy_FunctionPython)SetProvider(val cdktn.TerraformProvider) {
	_jsii_.Set(
		j,
		"provider",
		val,
...
func FunctionPython_GenerateConfigForImport(scope constructs.Construct, importToId *string, importFromId *string, provider cdktn.TerraformProvider) cdktn.ImportableResource {
	_init_.Initialize()
...
func (f *jsiiProxy_FunctionPython) GetBooleanAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (f *jsiiProxy_FunctionPython) ImportFrom(id *string, provider cdktn.TerraformProvider) {
...
func (f *jsiiProxy_FunctionPython) InterpolationForAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (f *jsiiProxy_FunctionPython) MarkWriteOnlyAttribute(value interface{}) interface{} {
...
func (f *jsiiProxy_FunctionPython) RegisterProviderFeatureUsage(feature cdktn.ProviderFeature) {
...
func (f *jsiiProxy_FunctionPython) With(mixins ...constructs.IMixin) constructs.IConstruct {
	args := []interface{}{}
