...
func (u *jsiiProxy_UserPublicKeys) MarkWriteOnlyAttribute(value interface{}) interface{} {
...
func (u *jsiiProxy_UserPublicKeys) RegisterProviderFeatureUsage(feature cdktn.ProviderFeature) {
...
func (u *jsiiProxy_UserPublicKeys) With(mixins ...constructs.IMixin) constructs.IConstruct {
	args := []interface{}{}
