...
func (j *jsiiProxy_ProcedurePython) CdktfStack() cdktn.TerraformStack {
...
func (j *jsiiProxy_ProcedurePython) ForEach() cdktn.ITerraformIterator {
...
func (j *jsiiProxy_ProcedurePython) Lifecycle() *cdktn.TerraformResourceLifecycle {
...
func (j *jsiiProxy_ProcedurePython) LogEventLevel() *string {
	var returns *string
	_jsii_.Get(
		j,
		"logEventLevel",
...
func (j *jsiiProxy_ProcedurePython) LogEventLevelInput() *string {
	var returns *string
	_jsii_.Get(
		j,
		"logEventLevelInput",
...
func (j *jsiiProxy_ProcedurePython) Provider() cdktn.TerraformProvider {
...
func (j *jsiiProxy_ProcedurePython) TerraformGeneratorMetadata() *cdktn.TerraformProviderGeneratorMetadata {
...
func (j *jsiiProxy_ProcedurePython)SetForEach(val cdktn.ITerraformIterator) {
	_jsii_.Set(
		j,
		"forEach",
		val,
...
func (j *jsiiProxy_ProcedurePython)SetLifecycle(val *cdktn.TerraformResourceLifecycle) {
...
func (j *jsiiProxy_ProcedurePython)SetLogEventLevel(val *string) {
...
func (j *jsiiProxy_ProcedurePython)SetProvider(val cdktn.TerraformProvider) {
	_jsii_.Set(
		j,
		"provider",
		val,
...
func ProcedurePython_GenerateConfigForImport(scope constructs.Construct, importToId *string, importFromId *string, provider cdktn.TerraformProvider) cdktn.ImportableResource {
	_init_.Initialize()
...
func (p *jsiiProxy_ProcedurePython) GetBooleanAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (p *jsiiProxy_ProcedurePython) ImportFrom(id *string, provider cdktn.TerraformProvider) {
...
func (p *jsiiProxy_ProcedurePython) InterpolationForAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (p *jsiiProxy_ProcedurePython) MarkWriteOnlyAttribute(value interface{}) interface{} {
...
func (p *jsiiProxy_ProcedurePython) RegisterProviderFeatureUsage(feature cdktn.ProviderFeature) {
...
func (p *jsiiProxy_ProcedurePython) ResetLogEventLevel() {
	_jsii_.InvokeVoid(
		p,
		"resetLogEventLevel",
		nil, // no parameters
...
func (p *jsiiProxy_ProcedurePython) With(mixins ...constructs.IMixin) constructs.IConstruct {
	args := []interface{}{}
