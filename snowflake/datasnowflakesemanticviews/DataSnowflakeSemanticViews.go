...
func (d *jsiiProxy_DataSnowflakeSemanticViews) RegisterProviderFeatureUsage(feature cdktn.ProviderFeature) {
...
func (d *jsiiProxy_DataSnowflakeSemanticViews) With(mixins ...constructs.IMixin) constructs.IConstruct {
	args := []interface{}{}
