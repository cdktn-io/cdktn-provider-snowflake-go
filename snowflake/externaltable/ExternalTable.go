...
func (e *jsiiProxy_ExternalTable) MarkWriteOnlyAttribute(value interface{}) interface{} {
...
func (e *jsiiProxy_ExternalTable) RegisterProviderFeatureUsage(feature cdktn.ProviderFeature) {
