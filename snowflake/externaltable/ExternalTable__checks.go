...
func (e *jsiiProxy_ExternalTable) validatePutColumnParameters(value interface{}) error {
	...
	default:
		if !_jsii_.IsAnonymousProxy(value) {
			return fmt.Errorf("parameter value must be one of the allowed types: cdktn.IResolvable, *[]*ExternalTableColumn; received %#v (a %T)", value, value)
		}
	}
...
func (e *jsiiProxy_ExternalTable) validatePutTagParameters(value interface{}) error {
	...
	default:
		if !_jsii_.IsAnonymousProxy(value) {
			return fmt.Errorf("parameter value must be one of the allowed types: cdktn.IResolvable, *[]*ExternalTableTag; received %#v (a %T)", value, value)
		}
	}
