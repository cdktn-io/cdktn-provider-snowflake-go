...
func (j *jsiiProxy_CatalogIntegrationOpenCatalog) CatalogSource() *string {
	var returns *string
	_jsii_.Get(
		j,
		"catalogSource",
...
func (c *jsiiProxy_CatalogIntegrationOpenCatalog) MarkWriteOnlyAttribute(value interface{}) interface{} {
...
func (c *jsiiProxy_CatalogIntegrationOpenCatalog) RegisterProviderFeatureUsage(feature cdktn.ProviderFeature) {
