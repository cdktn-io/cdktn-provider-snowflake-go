...
func init() {
	_jsii_.RegisterClass(
		...
		reflect.TypeOf((*FileFormatXml)(nil)).Elem(),
		[]_jsii_.Member{
	...
	_jsii_.RegisterStruct(
		"@cdktn/provider-snowflake.fileFormatXml.FileFormatXmlConfig",
		reflect.TypeOf((*FileFormatXmlConfig)(nil)).Elem(),
	)
	_jsii_.RegisterStruct(
		"@cdktn/provider-snowflake.fileFormatXml.FileFormatXmlDescribeOutput",
		reflect.TypeOf((*FileFormatXmlDescribeOutput)(nil)).Elem(),
	)
	_jsii_.RegisterClass(
		"@cdktn/provider-snowflake.fileFormatXml.FileFormatXmlDescribeOutputList",
		reflect.TypeOf((*FileFormatXmlDescribeOutputList)(nil)).Elem(),
		[]_jsii_.Member{
	...
	_jsii_.RegisterClass(
		...
		reflect.TypeOf((*FileFormatXmlDescribeOutputOutputReference)(nil)).Elem(),
		[]_jsii_.Member{
	...
	_jsii_.RegisterStruct(
		"@cdktn/provider-snowflake.fileFormatXml.FileFormatXmlShowOutput",
		reflect.TypeOf((*FileFormatXmlShowOutput)(nil)).Elem(),
	)
	_jsii_.RegisterClass(
		"@cdktn/provider-snowflake.fileFormatXml.FileFormatXmlShowOutputList",
		reflect.TypeOf((*FileFormatXmlShowOutputList)(nil)).Elem(),
		[]_jsii_.Member{
			_jsii_.MemberMethod{JsiiMethod: "allWithMapKey", GoMethod: "AllWithMapKey"},
			_jsii_.MemberMethod{JsiiMethod: "computeFqn", GoMethod: "ComputeFqn"},
			_jsii_.MemberProperty{JsiiProperty: "creationStack", GoGetter: "CreationStack"},
	...
	_jsii_.RegisterClass(
		"@cdktn/provider-snowflake.fileFormatXml.FileFormatXmlShowOutputOutputReference",
		reflect.TypeOf((*FileFormatXmlShowOutputOutputReference)(nil)).Elem(),
		[]_jsii_.Member{
			_jsii_.MemberProperty{JsiiProperty: "comment", GoGetter: "Comment"},
			_jsii_.MemberProperty{JsiiProperty: "complexObjectIndex", GoGetter: "ComplexObjectIndex"},
			_jsii_.MemberProperty{JsiiProperty: "complexObjectIsFromSet", GoGetter: "ComplexObjectIsFromSet"},
		...
		func() interface{} {
			j := jsiiProxy_FileFormatXmlShowOutputOutputReference{}
			_jsii_.InitJsiiProxy(&j.Type__cdktnComplexObject)
			return &j
		},
	)
	_jsii_.RegisterStruct(
		"@cdktn/provider-snowflake.fileFormatXml.FileFormatXmlTimeouts",
		reflect.TypeOf((*FileFormatXmlTimeouts)(nil)).Elem(),
	)
	_jsii_.RegisterClass(
		"@cdktn/provider-snowflake.fileFormatXml.FileFormatXmlTimeoutsOutputReference",
		reflect.TypeOf((*FileFormatXmlTimeoutsOutputReference)(nil)).Elem(),
		[]_jsii_.Member{
			_jsii_.MemberProperty{JsiiProperty: "complexObjectIndex", GoGetter: "ComplexObjectIndex"},
			_jsii_.MemberProperty{JsiiProperty: "complexObjectIsFromSet", GoGetter: "ComplexObjectIsFromSet"},
			_jsii_.MemberMethod{JsiiMethod: "computeFqn", GoMethod: "ComputeFqn"},
