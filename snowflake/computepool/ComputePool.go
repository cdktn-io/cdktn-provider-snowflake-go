...
func (c *jsiiProxy_ComputePool) MarkWriteOnlyAttribute(value interface{}) interface{} {
...
func (c *jsiiProxy_ComputePool) RegisterProviderFeatureUsage(feature cdktn.ProviderFeature) {
...
func (c *jsiiProxy_ComputePool) With(mixins ...constructs.IMixin) constructs.IConstruct {
	args := []interface{}{}
