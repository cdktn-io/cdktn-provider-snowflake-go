...
func init() {
	_jsii_.RegisterClass(
		...
		[]_jsii_.Member{
			...
			_jsii_.MemberProperty{JsiiProperty: "backupInstanceFamilies", GoGetter: "BackupInstanceFamilies"},
			_jsii_.MemberProperty{JsiiProperty: "backupInstanceFamiliesInput", GoGetter: "BackupInstanceFamiliesInput"},
			...
			_jsii_.MemberMethod{JsiiMethod: "resetBackupInstanceFamilies", GoMethod: "ResetBackupInstanceFamilies"},
