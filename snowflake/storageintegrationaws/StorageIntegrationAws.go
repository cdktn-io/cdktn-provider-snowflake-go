...
func (s *jsiiProxy_StorageIntegrationAws) MarkWriteOnlyAttribute(value interface{}) interface{} {
...
func (s *jsiiProxy_StorageIntegrationAws) RegisterProviderFeatureUsage(feature cdktn.ProviderFeature) {
...
func (s *jsiiProxy_StorageIntegrationAws) With(mixins ...constructs.IMixin) constructs.IConstruct {
	args := []interface{}{}
