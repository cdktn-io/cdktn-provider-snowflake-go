...
func (s *jsiiProxy_ServiceUserParametersStatementQueuedTimeoutInSecondsList) validateResolveParameters(context cdktn.IResolveContext) error {
	return nil
}
...
func (j *jsiiProxy_ServiceUserParametersStatementQueuedTimeoutInSecondsList) validateSetTerraformResourceParameters(val cdktn.IInterpolatingParent) error {
	return nil
}
...
func validateNewServiceUserParametersStatementQueuedTimeoutInSecondsListParameters(terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) error {
	return nil
}
