...
func (j *jsiiProxy_ServiceUserParametersAbortDetachedQueryOutputReference) TerraformResource() cdktn.IInterpolatingParent {
...
func NewServiceUserParametersAbortDetachedQueryOutputReference(terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, complexObjectIndex *float64, complexObjectIsFromSet *bool) ServiceUserParametersAbortDetachedQueryOutputReference {
	_init_.Initialize()
...
func NewServiceUserParametersAbortDetachedQueryOutputReference_Override(s ServiceUserParametersAbortDetachedQueryOutputReference, terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, complexObjectIndex *float64, complexObjectIsFromSet *bool) {
	_init_.Initialize()
...
func (j *jsiiProxy_ServiceUserParametersAbortDetachedQueryOutputReference)SetTerraformResource(val cdktn.IInterpolatingParent) {
...
func (s *jsiiProxy_ServiceUserParametersAbortDetachedQueryOutputReference) GetBooleanAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (s *jsiiProxy_ServiceUserParametersAbortDetachedQueryOutputReference) InterpolationAsList() cdktn.IResolvable {
	var returns cdktn.IResolvable
...
func (s *jsiiProxy_ServiceUserParametersAbortDetachedQueryOutputReference) InterpolationForAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (s *jsiiProxy_ServiceUserParametersAbortDetachedQueryOutputReference) Resolve(context cdktn.IResolveContext) interface{} {
