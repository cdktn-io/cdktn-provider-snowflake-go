...
func (s *jsiiProxy_ServiceUserParametersClientPrefetchThreadsList) validateResolveParameters(context cdktn.IResolveContext) error {
	return nil
}
...
func (j *jsiiProxy_ServiceUserParametersClientPrefetchThreadsList) validateSetTerraformResourceParameters(val cdktn.IInterpolatingParent) error {
	return nil
}
...
func validateNewServiceUserParametersClientPrefetchThreadsListParameters(terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) error {
	return nil
}
